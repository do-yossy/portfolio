...
NEW=('<!-- wp:html -->\n<style id="sv-global-hdr">\n'
 ...
 ':root{--color_header_bg:rgba(15,35,80,.92) !important}\n'
 '.l-header{background:rgba(15,35,80,.92) !important}\n'
 '.l-header__bar{background:transparent !important}\n'
 '.l-fixHeader{background:transparent !important}\n'
 '.l-fixHeader::before,.l-fixHeader:before{background:rgba(15,35,80,.92) !important}\n'
 '</style>\n<!-- /wp:html -->')
