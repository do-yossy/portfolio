...
module.exports = [
  ...
  { no: 6, name: '販売ページ', phase: 'PHASE4', usePrompt: 'No.21', steps: [12, 21] },
  { no: 7, name: '販売導線', phase: 'PHASE4', usePrompt: '販売開始チェックリスト', steps: [], external: '販売開始チェックリスト', setupLink: { href: '/product#payment', text: '決済方法・振込先を設定する' } },
