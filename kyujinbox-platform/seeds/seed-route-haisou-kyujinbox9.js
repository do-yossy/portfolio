'use strict';
// ルート配送ドライバー（企業配送）求人15件・第9弾（求人ボックス掲載）
// 大阪府内・主要都市の未使用エリア（第1〜8弾と全エリア重複なし）
// 給与は「月給42万円〜62万円」
// 冪等: 対象拠点のみ削除してから作り直す
...
// 3弾大阪市: 中央区船場,北区中津,西区阿波座,淀川区新大阪,港区弁天町,住之江区南港,此花区西九条,西淀川区御幣島,東成区今里,旭区千林,鶴見区横堤,住吉区我孫子,西成区玉出,大正区鶴町,東淀川区上新庄
// 5弾大阪: 高槻市摂津富田,枚方市樟葉
// 6弾大阪市: 都島区桜宮,福島区福島,城東区蒲生,生野区桃谷,阿倍野区昭和町,東住吉区針中野,平野区長吉,浪速区難波,天王寺区上本町
// 6弾大阪府: 豊中市庄内,吹田市豊津,茨木市総持寺,東大阪市荒本,八尾市南八尾,守口市滝井
// 7弾大阪府: 松原市天美,大東市野崎,四條畷市忍ヶ丘,藤井寺市藤井寺,羽曳野市高鷲,泉大津市泉大津,岸和田市東岸和田,池田市池田,箕面市箕面,摂津市正雀,寝屋川市寝屋川,堺市北区新金岡,堺市堺区堺,高槻市高槻,枚方市牧野
// 本弾: 大阪市主要区＋大阪府主要市の未使用サブエリア（駅・町名単位）
const AREAS = [
  { pref: '大阪府', city: '大阪市',   district: '北区梅田',       client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市',   district: '中央区本町',     client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市',   district: '淀川区十三',     client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市',   district: '東淀川区淡路',   client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市',   district: '西区九条',       client: '医療機器・日用品卸' },
  { pref: '大阪府', city: '大阪市',   district: '生野区鶴橋',     client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '大阪市',   district: '住之江区平林',   client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市',   district: '平野区平野本町', client: '企業・事業所向け日用品' },
  { pref: '大阪府', city: '堺市',     district: '中区深井',       client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '東大阪市', district: '布施',           client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '枚方市',   district: '岡東町',         client: '食品・日用品卸売' },
  { pref: '大阪府', city: '高槻市',   district: '芥川',           client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '吹田市',   district: '江坂',           client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '茨木市',   district: '駅前本町',       client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '豊中市',   district: '千里中央',       client: '食品・飲料メーカー' },
];
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第9弾・大阪府主要都市の未使用エリア15件）`);
