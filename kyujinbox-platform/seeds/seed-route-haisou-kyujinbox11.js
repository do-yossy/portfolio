'use strict';
// ルート配送ドライバー（企業配送）求人15件・第11弾（求人ボックス掲載）
// 大阪近辺（大阪府・京都府）の未使用エリア（第7〜10弾と全エリア重複なし）
// 給与は「月給42万円〜62万円」
// 冪等: 対象拠点のみ削除してから作り直す
...
// 本弾: 大阪近辺（大阪府・京都府）の未使用エリア。
// 既使用（第7〜10弾）と重複しない大阪市内各区・大阪府下市・大阪近接の京都府で構成。
const AREAS = [
  { pref: '大阪府', city: '大阪市',   district: '都島区都島本通', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市',   district: '福島区福島',     client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市',   district: '港区弁天町',     client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市',   district: '城東区蒲生',     client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市',   district: '阿倍野区阿倍野', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市',   district: '東住吉区駒川',   client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市',   district: '旭区千林',       client: '食品・日用品卸売' },
  { pref: '大阪府', city: '堺市',     district: '西区鳳',         client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '守口市',   district: '守口',           client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '門真市',   district: '門真',           client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '和泉市',   district: '和泉中央',       client: '食品・日用品卸売' },
  { pref: '大阪府', city: '交野市',   district: '交野',           client: '企業・商業施設向け日用品' },
  { pref: '京都府', city: '久御山町', district: '佐山',           client: '工場・物流センター向け' },
  { pref: '京都府', city: '大山崎町', district: '円明寺',         client: '食品・工業資材メーカー' },
  { pref: '京都府', city: '木津川市', district: '木津',           client: '工場・倉庫向け資材' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第11弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第11弾・大阪近辺（大阪・京都）の未使用エリア15件）`);
