'use strict';
// ルート配送ドライバー（企業配送）求人15件・第17弾（求人ボックス掲載）
// 大阪市内の未使用エリア（第7〜16弾と勤務地の重複なし・別地名で構成）
// 給与は「月給42万円〜62万円」
...
// 本弾: 大阪市内の未使用エリア（第7〜16弾で使った地名とは別の町名で構成）。
const AREAS = [
  { pref: '大阪府', city: '大阪市', district: '北区天満',     client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '福島区大開',   client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '此花区酉島',   client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '西区立売堀',   client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '港区波除',     client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市', district: '大正区千島',   client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '天王寺区生玉',  client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市', district: '浪速区敷津',   client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '西淀川区出来島', client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '大阪市', district: '東淀川区瑞光',  client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '東成区東今里',  client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '生野区田島',   client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '城東区鴫野',   client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '淀川区三国',   client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '住之江区粉浜',  client: '工場・倉庫向け資材' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第17弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第17弾・大阪市内の未使用エリア15件・応募情報を踏まえ内容強化）`);
