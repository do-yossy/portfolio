'use strict';
// 工場軽作業スタッフ 求人10件・第2弾・全国（求人ボックス掲載）
// 月収30万円以上（月給30〜37万円）・第1弾10件と被りなし
// 冪等: 対象拠点のみ削除してから作り直す
...
// 全国10エリア（第1弾・工場内梱包・機械オペレーター全弾と被りなし）
// 第1弾使用: 帯広,盛岡,山形,宇都宮,水戸,長野,浜松,大津,松山,熊本
// 梱包使用: 函館,青森,福島,高崎,船橋,厚木,岡崎,高松,福岡,鹿児島
// 機械使用: 苫小牧,石巻,秋田,仙台,八戸,いわき,川口,千葉,太田,富山,大垣,一宮,豊田,
//          岡山,姫路,倉敷,福山,四日市,津,伊万里,大牟田,長崎,八代,坂出,那覇,下関 ほか
const AREAS = [
  { pref: '福井県',   city: '福井市',   facility: '食品・機械部品製造工場' },
  { pref: '山梨県',   city: '甲府市',   facility: '精密機器・食品加工工場' },
  { pref: '岐阜県',   city: '岐阜市',   facility: '製造工場・部品組立ライン' },
  { pref: '奈良県',   city: '奈良市',   facility: '食品・日用品軽作業センター' },
  { pref: '和歌山県', city: '和歌山市', facility: '化学・食品製造工場' },
  { pref: '島根県',   city: '松江市',   facility: '食品・製造工場軽作業ライン' },
  { pref: '山口県',   city: '山口市',   facility: '製造工場・軽作業センター' },
  { pref: '佐賀県',   city: '佐賀市',   facility: '食品・日用品軽作業センター' },
  { pref: '宮崎県',   city: '宮崎市',   facility: '食品加工・物流軽作業センター' },
  { pref: '沖縄県',   city: '沖縄市',   facility: '食品・物流軽作業センター' },
];
...
console.log(`\n完了: ${created}件作成（${SALARY_INCOME}・工場軽作業スタッフ・全国10件・第2弾）`);
