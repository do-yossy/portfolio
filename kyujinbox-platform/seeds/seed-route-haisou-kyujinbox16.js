'use strict';
// ルート配送ドライバー（企業配送）求人15件・第16弾（求人ボックス掲載）
// 大阪市内の未使用エリア（第7〜15弾と勤務地の重複なし・別地名で構成）
// 給与は「月給42万円〜62万円」
// 冪等: 対象拠点のみ削除してから作り直す
...
// 本弾: 大阪市内の未使用エリア。第7〜15弾で使った地名とは別の町名で構成（勤務地文字列の重複なし）。
const AREAS = [
  { pref: '大阪府', city: '大阪市', district: '北区中崎町',     client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '福島区野田',     client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '此花区西九条',   client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '西区阿波座',     client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '港区田中',       client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市', district: '大正区泉尾',     client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '天王寺区悲田院町', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市', district: '浪速区恵美須',   client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '西淀川区竹島',   client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '大阪市', district: '東淀川区井高野', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '東成区中道',     client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '生野区勝山',     client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '旭区高殿',       client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '城東区諏訪',     client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '住吉区帝塚山',   client: '工場・倉庫向け資材' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第16弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第16弾・大阪市内の未使用エリア15件）`);
