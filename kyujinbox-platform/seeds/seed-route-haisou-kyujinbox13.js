'use strict';
// ルート配送ドライバー（企業配送）求人15件・第13弾（求人ボックス掲載）
// 大阪府＋大阪近接の京都府の未使用エリア（第7〜12弾と全エリア重複なし）
// 給与は「月給42万円〜62万円」
// 冪等: 対象拠点のみ削除してから作り直す
...
// 本弾: 大阪市24区は第7〜12弾で使い切ったため、大阪府下市町(未使用)＋大阪近接の京都市各区で構成。
// 第7〜12弾と全エリア重複なし。
const AREAS = [
  { pref: '大阪府', city: '八尾市',       district: '八尾',         client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪狭山市',   district: '狭山',         client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '阪南市',       district: '尾崎',         client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '泉南市',       district: '樽井',         client: '食品・日用品卸売' },
  { pref: '大阪府', city: '堺市',         district: '東区北野田',   client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '堺市',         district: '南区栂',       client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '堺市',         district: '美原区黒山',   client: '工場・物流センター向け' },
  { pref: '大阪府', city: '熊取町',       district: '熊取',         client: '食品・日用品卸売' },
  { pref: '大阪府', city: '岬町',         district: '淡輪',         client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '忠岡町',       district: '忠岡',         client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '田尻町',       district: '吉見',         client: '食品・日用品卸売' },
  { pref: '京都府', city: '京都市',       district: '南区東九条',   client: '企業・商業施設向け日用品' },
  { pref: '京都府', city: '京都市',       district: '伏見区深草',   client: '食品・工業資材メーカー' },
  { pref: '京都府', city: '京都市',       district: '山科区椥辻',   client: '医療機器・事業所向け用品' },
  { pref: '京都府', city: '京都市',       district: '中京区壬生',   client: '工場・倉庫向け資材' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第13弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第13弾・大阪府＋大阪近接京都の未使用エリア15件）`);
