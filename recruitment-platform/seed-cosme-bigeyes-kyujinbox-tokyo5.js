...
const AREAS = [
  ...
  { pref: '東京都', city: '練馬区', district: '豊玉北' },
  { pref: '東京都', city: '杉並区', district: '高円寺南' },
  { pref: '東京都', city: '中野区', district: '新井' },
  { pref: '東京都', city: '目黒区', district: '中目黒' },
...
console.log(`\n完了: ${created}件作成（Bigeyes・コスメ製造スタッフ・東京10件(第5弾)・本文は求人No.5148-4590-0005と同一）`);
