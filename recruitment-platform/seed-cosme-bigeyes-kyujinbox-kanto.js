...
// 東京・埼玉・神奈川エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '大田区', district: '京浜島' },
  { pref: '東京都', city: '江東区', district: '潮見' },
  { pref: '東京都', city: '板橋区', district: '前野町' },
  { pref: '東京都', city: '足立区', district: '入谷' },
  { pref: '東京都', city: '八王子市', district: '北野町' },
  { pref: '埼玉県', city: 'さいたま市', district: '岩槻区' },
  { pref: '埼玉県', city: '川口市', district: '領家' },
  { pref: '埼玉県', city: '越谷市', district: 'レイクタウン' },
  { pref: '埼玉県', city: '所沢市', district: 'くすのき台' },
  { pref: '埼玉県', city: '三郷市', district: '彦成' },
  { pref: '神奈川県', city: '横浜市', district: '金沢区福浦' },
  { pref: '神奈川県', city: '川崎市', district: '川崎区扇町' },
  { pref: '神奈川県', city: '相模原市', district: '中央区田名' },
  { pref: '神奈川県', city: '厚木市', district: '温水' },
  { pref: '神奈川県', city: '藤沢市', district: '辻堂' },
];
...
console.log(`\n完了: ${created}件作成（Bigeyes・コスメ製造スタッフ・東京・埼玉・神奈川15件・本文は求人No.5148-4590-0005と同一）`);
