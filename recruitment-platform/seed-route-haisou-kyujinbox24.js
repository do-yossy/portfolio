'use strict';
// ルート配送ドライバー（企業配送）求人15件・第24弾（求人ボックス掲載）
...
const AREAS = [
  { pref: '大阪府', city: '大阪市', district: '中央区内本町', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '住之江区安立', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '住吉区我孫子', client: '化学・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市', district: '北区大淀', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '城東区森之宮', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市', district: '天王寺区堀越町', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '旭区清水', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '東成区東小橋', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '東淀川区大隅', client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '大阪市', district: '浪速区幸町', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '淀川区田川', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '生野区舎利寺', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '西区土佐堀', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '西淀川区中島', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '平野区背戸口', client: '工場・倉庫向け資材' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第24弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第24弾・大阪市内の未使用エリア15件・応募情報を踏まえ内容強化）`);
