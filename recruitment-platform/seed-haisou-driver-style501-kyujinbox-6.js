...
const AREAS = [
  { pref: '東京都', city: '世田谷区', district: '松原' },
  { pref: '東京都', city: '中野区', district: '若宮' },
  { pref: '東京都', city: '北区', district: '岩淵町' },
  { pref: '東京都', city: '品川区', district: '豊町' },
  { pref: '東京都', city: '大田区', district: '矢口' },
  { pref: '東京都', city: '杉並区', district: '宮前' },
  { pref: '東京都', city: '板橋区', district: '大谷口' },
  { pref: '東京都', city: '江戸川区', district: '北小岩' },
  { pref: '東京都', city: '江東区', district: '北砂' },
  { pref: '東京都', city: '目黒区', district: '目黒本町' },
  { pref: '東京都', city: '練馬区', district: '貫井' },
  { pref: '東京都', city: '荒川区', district: '東日暮里' },
  { pref: '東京都', city: '葛飾区', district: '南水元' },
  { pref: '東京都', city: '足立区', district: '東和' },
  { pref: '東京都', city: '世田谷区', district: '尾山台' },
];
...
console.log(`\n完了: ${created}件作成（Style501・配送ドライバー・東京都15件(第4弾)）`);
