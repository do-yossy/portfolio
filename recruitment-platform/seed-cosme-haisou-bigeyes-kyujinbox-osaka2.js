...
// 大阪府内15エリア第2弾（Bigeyes コスメ配送ドライバーの勤務地。他職種と重複なし）
const AREAS = [
...
console.log(`\n完了: ${created}件作成（Bigeyes・コスメ配送ドライバー・大阪府15件(第2弾)・本文は求人No.5148-4590-0001と同一）`);
