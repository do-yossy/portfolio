...
// 東京エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '中央区', district: '日本橋' },
  { pref: '東京都', city: '台東区', district: '浅草' },
  { pref: '東京都', city: '文京区', district: '小石川' },
  { pref: '東京都', city: '渋谷区', district: '代々木' },
];
...
console.log(`\n完了: ${created}件作成（Bigeyes・美容機器運搬ドライバー・東京4件・本文は求人No.5148-4590-0003と同一）`);
