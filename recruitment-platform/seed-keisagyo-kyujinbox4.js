'use strict';
// 工場軽作業スタッフ 求人10件・第4弾・全国（求人ボックス掲載）
// 月収30万円以上（月給30〜37万円）・第1〜3弾と被りなし
// 冪等: 対象拠点のみ削除してから作り直す
...
// 全国10エリア（軽作業第1〜3弾・機械オペレーター全弾・配送全弾と被りなし）
// 軽作業第1弾: 帯広,盛岡,山形,宇都宮,水戸,長野,浜松,大津,松山,熊本
// 軽作業第2弾: 福井,甲府,岐阜,奈良,和歌山,松江,山口,佐賀,宮崎,沖縄
// 軽作業第3弾: 旭川,熊谷,長岡,金沢,松本,松阪,徳島,東広島,今治,霧島
// 機械使用: 日立,横須賀,磐田,安城,堺,尼崎,岡山,呉,久留米,鈴鹿,市原,君津,平塚,碧南,大垣,高岡,
//          周南,大分,新居浜,いわき,神栖,太田,小山,甲賀,半田,和歌山,宇部,坂出,室蘭,相生,
//          大田区,長岡京,大和郡山,小松,坂井,甲斐,米子,阿南,南国,うるま ほか
// 本弾: 青森,郡山,川越,沼津,豊橋,彦根,鳥取,高知,佐世保,別府（いずれも未使用）
const AREAS = [
  { pref: '青森県',   city: '青森市',   facility: '食品・物流軽作業センター' },
  { pref: '福島県',   city: '郡山市',   facility: '製造工場・部品組立ライン' },
  { pref: '埼玉県',   city: '川越市',   facility: '食品・日用品軽作業センター' },
  { pref: '静岡県',   city: '沼津市',   facility: '食品・機械部品製造工場' },
  { pref: '愛知県',   city: '豊橋市',   facility: '製造工場・部品組立ライン' },
  { pref: '滋賀県',   city: '彦根市',   facility: '精密機器・部品製造工場' },
  { pref: '鳥取県',   city: '鳥取市',   facility: '食品・製造工場軽作業ライン' },
  { pref: '高知県',   city: '高知市',   facility: '食品・日用品軽作業センター' },
  { pref: '長崎県',   city: '佐世保市', facility: '食品・物流軽作業センター' },
  { pref: '大分県',   city: '別府市',   facility: '食品加工・物流軽作業センター' },
];
...
if (del.changes > 0) console.log(`既存工場軽作業スタッフ第4弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（${SALARY_INCOME}・工場軽作業スタッフ・全国10件・第4弾）`);
