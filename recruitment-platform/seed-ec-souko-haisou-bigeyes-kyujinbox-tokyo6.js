...
// 東京エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '江東区', district: '海辺' },
  { pref: '東京都', city: '大田区', district: '大森西' },
  { pref: '東京都', city: '江戸川区', district: '春江' },
  { pref: '東京都', city: '足立区', district: '古千谷' },
];
...
console.log(`\n完了: ${created}件作成（Bigeyes・EC倉庫配送スタッフ・東京4件(第4弾)・本文は求人No.5148-4590-0002と同一）`);
