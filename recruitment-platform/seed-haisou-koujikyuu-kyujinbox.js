'use strict';
// 高時給エリア配送ドライバー求人15件（求人ボックス掲載・大阪府市部＋大阪よりの兵庫・場所被りなし）
// 給与は掲載写真の「月給42万円〜62万円」に合わせる
// 冪等: 既存の高時給エリア配送ドライバー(求人ボックス)を削除してから作り直す
...
// 大阪市内は既存求人で使用済みのため、大阪府市部＋大阪よりの兵庫県を使用
// 除外済み: 大阪市全24区, 堺市北区（軽貨物・EC配送）
const AREAS = [
  { pref: '大阪府', city: '豊中市',   district: '岡町',     service: 'Amazon・EC通販大手' },
  { pref: '大阪府', city: '吹田市',   district: '江坂',     service: '楽天市場・Amazon倉庫直発' },
  { pref: '大阪府', city: '茨木市',   district: '南茨木',   service: '大型EC倉庫発・通販各社' },
  { pref: '大阪府', city: '高槻市',   district: '富田',     service: 'Yahoo!ショッピング・EC各社' },
  { pref: '大阪府', city: '枚方市',   district: '招提',     service: 'Amazon配送パートナー便' },
  { pref: '大阪府', city: '八尾市',   district: '近鉄八尾', service: 'Amazon・楽天EC大手' },
  { pref: '大阪府', city: '寝屋川市', district: '香里園',   service: 'EC通販各社・大型倉庫発' },
  { pref: '大阪府', city: '東大阪市', district: '布施',     service: '食品・日用品EC通販' },
  { pref: '大阪府', city: '守口市',   district: '大日',     service: '楽天・AmazonのEC配送' },
  { pref: '大阪府', city: '松原市',   district: '河内松原', service: '生活雑貨・日用品EC' },
  { pref: '大阪府', city: '堺市',     district: '堺区',     service: 'Amazon・EC通販各社' },
  { pref: '兵庫県', city: '尼崎市',   district: '武庫之荘', service: '大手EC倉庫発の配送' },
  { pref: '兵庫県', city: '西宮市',   district: '甲子園',   service: 'アパレル・雑貨EC各社' },
  { pref: '兵庫県', city: '伊丹市',   district: '伊丹',     service: 'スポーツ・家電EC配送' },
  { pref: '兵庫県', city: '宝塚市',   district: '逆瀬川',   service: 'EC通販各社・阪神エリア' },
];

const now = new Date().toISOString();
const expires = new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString();

// 既存の高時給エリア配送ドライバー(求人ボックス)を削除して作り直す
const del = db.prepare("DELETE FROM jobs WHERE job_type='高時給エリア配送ドライバー' AND target_media LIKE '%求人ボックス%'").run();
if (del.changes > 0) console.log(`既存高時給エリア配送ドライバーを削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（大阪府市部＋兵庫・${SALARY_INCOME}・写真付き）`);
