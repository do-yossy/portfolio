...
const AREAS = [
  { pref: '東京都', city: '大田区', district: '大森東' },
  { pref: '東京都', city: '大田区', district: '東海' },
  { pref: '東京都', city: '江東区', district: '東雲' },
  { pref: '東京都', city: '江戸川区', district: '北葛西' },
  { pref: '東京都', city: '板橋区', district: '坂下' },
  { pref: '東京都', city: '足立区', district: '綾瀬' },
  { pref: '東京都', city: '葛飾区', district: '青戸' },
  { pref: '東京都', city: '墨田区', district: '八広' },
  { pref: '東京都', city: '北区', district: '神谷' },
  { pref: '東京都', city: '品川区', district: '八潮' },
];
...
console.log(`\n完了: ${created}件作成（Bigeyes・コスメ製造スタッフ・東京10件・本文は求人No.5148-4590-0005と同一）`);
