...
const AREAS = [
  { pref: '東京都', city: '大田区', district: '南六郷' },
  { pref: '東京都', city: '江戸川区', district: '東葛西' },
  { pref: '東京都', city: '足立区', district: '六町' },
  { pref: '東京都', city: '葛飾区', district: '細田' },
  { pref: '東京都', city: '板橋区', district: '新河岸' },
  { pref: '東京都', city: '江東区', district: '若洲' },
  { pref: '東京都', city: '墨田区', district: '立花' },
  { pref: '東京都', city: '北区', district: '志茂' },
  { pref: '東京都', city: '品川区', district: '南大井' },
  { pref: '東京都', city: '大田区', district: '羽田旭町' },
];
...
console.log(`\n完了: ${created}件作成（Bigeyes・コスメ製造スタッフ・東京10件(第2弾)・本文は求人No.5148-4590-0005と同一）`);
