'use strict';
// 工場軽作業スタッフ 求人10件・第5弾・全国（求人ボックス掲載）
// 月収30万円以上（月給30〜37万円）・第1〜4弾と被りなし
// 冪等: 対象拠点のみ削除してから作り直す
...
// 全国10エリア（軽作業第1〜4弾・機械オペレーター全弾・配送全弾と被りなし）
// 本弾: 千歳,一関,大崎,伊勢崎,成田,藤沢,上越,津山,飯塚,鹿屋（いずれも未使用）
const AREAS = [
  { pref: '北海道',   city: '千歳市',   facility: '食品・物流軽作業センター' },
  { pref: '岩手県',   city: '一関市',   facility: '製造工場・部品組立ライン' },
  { pref: '宮城県',   city: '大崎市',   facility: '食品・機械部品製造工場' },
  { pref: '群馬県',   city: '伊勢崎市', facility: '製造工場・部品組立ライン' },
  { pref: '千葉県',   city: '成田市',   facility: '食品・物流軽作業センター' },
  { pref: '神奈川県', city: '藤沢市',   facility: '精密機器・部品製造工場' },
  { pref: '新潟県',   city: '上越市',   facility: '食品・製造工場軽作業ライン' },
  { pref: '岡山県',   city: '津山市',   facility: '食品・日用品軽作業センター' },
  { pref: '福岡県',   city: '飯塚市',   facility: '食品・物流軽作業センター' },
  { pref: '鹿児島県', city: '鹿屋市',   facility: '食品加工・物流軽作業センター' },
];
...
if (del.changes > 0) console.log(`既存工場軽作業スタッフ第5弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（${SALARY_INCOME}・工場軽作業スタッフ・全国10件・第5弾）`);
