'use strict';
// 工場軽作業スタッフ 求人10件・大阪府(第5弾)（求人ボックス掲載）
...
// 大阪府10エリア第5弾（工場軽作業スタッフ・既存と別の大阪市内10区）
// 本弾: 苫小牧,石巻,土浦,太田,春日部,木更津,厚木,小牧,舞鶴,大牟田（いずれも未使用・全都道府県も分散）
const AREAS = [
  { pref: '大阪府', city: '大阪市此花区', facility: '食品・日用品軽作業センター' },
  { pref: '大阪府', city: '大阪市西淀川区', facility: '化学・樹脂製品製造工場' },
  { pref: '大阪府', city: '大阪市大正区', facility: '金属・機械部品製造工場' },
  { pref: '大阪府', city: '大阪市住之江区', facility: '物流・EC軽作業センター' },
  { pref: '大阪府', city: '大阪市港区', facility: '食品・飲料製造工場' },
  { pref: '大阪府', city: '大阪市東淀川区', facility: '精密機器・部品組立工場' },
  { pref: '大阪府', city: '大阪市平野区', facility: '食品・日用品軽作業センター' },
  { pref: '大阪府', city: '大阪市生野区', facility: '樹脂・金属加工工場' },
  { pref: '大阪府', city: '大阪市城東区', facility: '医薬品・日用品製造工場' },
  { pref: '大阪府', city: '大阪市鶴見区', facility: '食品・物流軽作業センター' },
];
...
if (del.changes > 0) console.log(`既存工場軽作業スタッフ(大阪府第5弾分)を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（${SALARY_INCOME}・工場軽作業スタッフ・大阪府10件(第5弾)・応募情報を踏まえ内容強化）`);
