'use strict';
// ルート配送ドライバー（企業配送）求人15件・第25弾（求人ボックス掲載）
...
// 本弾: 大阪市内の未使用エリア15件（既存弾と別の町名で構成）。
const AREAS = [
  { pref: '大阪府', city: '大阪市', district: '此花区梅香', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '港区三先', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '大正区北村', client: '金属・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市', district: '西淀川区野里', client: '化学・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市', district: '淀川区東三国', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市', district: '東淀川区菅原', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '住之江区中加賀屋', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '住吉区墨江', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '東住吉区桑津', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '平野区瓜破', client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '大阪市', district: '生野区巽北', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '城東区古市', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '阿倍野区文の里', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '西成区天下茶屋', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '都島区東野田町', client: '企業・商業施設向け日用品' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第25弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第25弾・大阪市内の未使用エリア15件・応募情報を踏まえ内容強化）`);
