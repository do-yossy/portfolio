'use strict';
// 工場軽作業スタッフ 求人10件・第10弾・全国（求人ボックス掲載）
...
// 全国10エリア（工場軽作業第2〜9弾と被りなしの未使用都市）
// 本弾: 苫小牧,石巻,土浦,太田,春日部,木更津,厚木,小牧,舞鶴,大牟田（いずれも未使用・全都道府県も分散）
const AREAS = [
  { pref: '北海道', city: '函館市', facility: '食品・物流軽作業センター' },
  { pref: '青森県', city: '弘前市', facility: '製造工場・部品組立ライン' },
  { pref: '岩手県', city: '花巻市', facility: '食品・機械部品製造工場' },
  { pref: '山形県', city: '鶴岡市', facility: '食品加工・物流軽作業センター' },
  { pref: '茨城県', city: '日立市', facility: '精密機器・食品加工工場' },
  { pref: '神奈川県', city: '小田原市', facility: '製造工場・部品組立ライン' },
  { pref: '静岡県', city: '浜松市', facility: '食品・機械部品製造工場' },
  { pref: '愛知県', city: '春日井市', facility: '食品・日用品軽作業センター' },
  { pref: '兵庫県', city: '姫路市', facility: '化学・食品製造工場' },
  { pref: '広島県', city: '呉市', facility: '食品加工・物流軽作業センター' },
];
...
if (del.changes > 0) console.log(`既存工場軽作業スタッフ第10弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（${SALARY_INCOME}・工場軽作業スタッフ・全国10件・第10弾・応募情報を踏まえ内容強化）`);
