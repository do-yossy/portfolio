...
// 東京エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '渋谷区', district: '道玄坂' },
  { pref: '東京都', city: '港区', district: '新橋' },
  { pref: '東京都', city: '中央区', district: '築地' },
];
...
for (let i = 0; i < AREAS.length; i++) {
  ...
  const _v = vary.build('bg_hairsalon', areaLabel);
...
console.log(`\n完了: ${created}件作成（Bigeyes・ヘアサロン向け配送スタッフ・東京3件(第4弾)・本文は求人No.5148-4590-0004と同一）`);
