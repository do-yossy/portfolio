...
const AREAS = [
  { pref: '東京都', city: '世田谷区', district: '下馬' },
  { pref: '東京都', city: '中野区', district: '新井' },
  { pref: '東京都', city: '品川区', district: '旗の台' },
  { pref: '東京都', city: '大田区', district: '田園調布' },
  { pref: '東京都', city: '杉並区', district: '永福' },
  { pref: '東京都', city: '板橋区', district: '蓮根' },
  { pref: '東京都', city: '江戸川区', district: '平井' },
  { pref: '東京都', city: '練馬区', district: '桜台' },
  { pref: '東京都', city: '葛飾区', district: '四つ木' },
  { pref: '東京都', city: '足立区', district: '関原' },
];
...
console.log(`\n完了: ${created}件作成（Style501・送迎ドライバー・東京都10件(第2弾)）`);
