'use strict';
// 工場軽作業スタッフ 求人10件・大阪府(第4弾)（求人ボックス掲載）
...
// 大阪府10エリア第4弾（工場軽作業スタッフ・既存と別の大阪府内10市町）
// 本弾: 苫小牧,石巻,土浦,太田,春日部,木更津,厚木,小牧,舞鶴,大牟田（いずれも未使用・全都道府県も分散）
const AREAS = [
  { pref: '大阪府', city: '交野市', facility: '食品・日用品軽作業センター' },
  { pref: '大阪府', city: '大阪狭山市', facility: '製造工場・部品組立ライン' },
  { pref: '大阪府', city: '阪南市', facility: '食品・化粧品軽作業センター' },
  { pref: '大阪府', city: '忠岡町', facility: '食品・飲料製造工場' },
  { pref: '大阪府', city: '熊取町', facility: '樹脂・金属部品製造工場' },
  { pref: '大阪府', city: '田尻町', facility: '医薬品・日用品製造工場' },
  { pref: '大阪府', city: '岬町', facility: '化学・食品製造工場' },
  { pref: '大阪府', city: '島本町', facility: '精密機器・部品組立工場' },
  { pref: '大阪府', city: '太子町', facility: '食品・物流軽作業センター' },
  { pref: '大阪府', city: '河南町', facility: '金属・機械部品製造工場' },
];
...
if (del.changes > 0) console.log(`既存工場軽作業スタッフ(大阪府第4弾分)を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（${SALARY_INCOME}・工場軽作業スタッフ・大阪府10件(第4弾)・応募情報を踏まえ内容強化）`);
