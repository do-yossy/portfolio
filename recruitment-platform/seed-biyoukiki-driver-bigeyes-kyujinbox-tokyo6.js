...
// 東京エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '中央区', district: '京橋' },
  { pref: '東京都', city: '品川区', district: '西五反田' },
  { pref: '東京都', city: '台東区', district: '三ノ輪' },
  { pref: '東京都', city: '中野区', district: '本町' },
];
...
for (let i = 0; i < AREAS.length; i++) {
  ...
  const _v = vary.build('bg_biyoukiki', areaLabel);
...
console.log(`\n完了: ${created}件作成（Bigeyes・美容機器運搬ドライバー・東京4件(第4弾)・本文は求人No.5148-4590-0003と同一）`);
