...
// 大阪府内10エリア（Style501 送迎ドライバー・大阪・既存分と被りなし）
const AREAS = [
  { pref: '大阪府', city: '大阪市', district: '淀川区十三' },
  { pref: '大阪府', city: '大阪市', district: '都島区友渕町' },
  { pref: '大阪府', city: '大阪市', district: '旭区森小路' },
  { pref: '大阪府', city: '高槻市', district: '富田町' },
  { pref: '大阪府', city: '茨木市', district: '春日' },
  { pref: '大阪府', city: '摂津市', district: '千里丘' },
  { pref: '大阪府', city: '守口市', district: '桜町' },
  { pref: '大阪府', city: '門真市', district: '幸福町' },
  { pref: '大阪府', city: '大東市', district: '住道' },
  { pref: '大阪府', city: '四條畷市', district: '楠公' },
];
...
console.log(`\n完了: ${created}件作成（Style501・送迎ドライバー・大阪府10件）`);
