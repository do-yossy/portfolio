...
// 東京エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '中央区', district: '八丁堀' },
  { pref: '東京都', city: '新宿区', district: '高田馬場' },
  { pref: '東京都', city: '豊島区', district: '東池袋' },
...
console.log(`\n完了: ${created}件作成（Bigeyes・コスメ配送ドライバー・東京4件・本文は求人No.5148-4590-0001と同一）`);
