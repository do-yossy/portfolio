...
// 東京エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '文京区', district: '後楽' },
  { pref: '東京都', city: '台東区', district: '蔵前' },
  { pref: '東京都', city: '墨田区', district: '両国' },
];
...
console.log(`\n完了: ${created}件作成（Bigeyes・コスメ配送ドライバー・東京3件・本文は求人No.5148-4590-0001と同一）`);
