'use strict';
// 送迎ドライバー 求人15件（Style501・求人ボックス掲載）
...
const TITLE_TAIL = '【事業拡大につき事業継承】送迎ドライバー★未経験歓迎★資産形成OK★月給39万円以上';
const SALARY_DETAIL = '月給390,000円〜440,000円';

// 東京都内15エリア（Style501 送迎ドライバーの勤務地）
const AREAS = [
  { pref: '東京都', city: '足立区',   district: '千住' },
  { pref: '東京都', city: '江戸川区', district: '中葛西' },
  { pref: '東京都', city: '葛飾区',   district: '新小岩' },
  { pref: '東京都', city: '板橋区',   district: '高島平' },
  { pref: '東京都', city: '練馬区',   district: '大泉学園' },
  { pref: '東京都', city: '北区',     district: '赤羽' },
  { pref: '東京都', city: '荒川区',   district: '南千住' },
  { pref: '東京都', city: '江東区',   district: '東雲' },
  { pref: '東京都', city: '大田区',   district: '蒲田' },
  { pref: '東京都', city: '品川区',   district: '大井' },
  { pref: '東京都', city: '世田谷区', district: '上馬' },
  { pref: '東京都', city: '杉並区',   district: '高円寺' },
  { pref: '東京都', city: '中野区',   district: '中野' },
  { pref: '東京都', city: '豊島区',   district: '池袋' },
  { pref: '東京都', city: '八王子市', district: '明神町' },
];

const DESCRIPTION = `従業員の送迎を中心としたドライバーのお仕事です。

決まったルート・拠点間の送迎が中心で、あわせて資材や荷物の運搬・積み下ろし補助をお願いすることがあります。

型にはまった働き方ではなく、未経験の方でも安心して始められるよう、丁寧にサポートします。
...
運転に慣れていない方・ブランクのある方も、少しずつ独り立ちできるようサポートします。`;
...
for (let i = 0; i < AREAS.length; i++) {
  ...
  const catchcopy = `未経験歓迎★従業員の送迎を中心としたドライバー★月給39万円〜44万円（年収500万円以上も可能）。AT限定OK・ブランク・シニアも歓迎。残業ほぼなし・日勤メインで、正社員として安定して長く働けます。`;
...
console.log(`\n完了: ${created}件作成（Style501・送迎ドライバー・東京都15件）`);
