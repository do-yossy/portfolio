...
// 東京都内15エリア（Style501 配送ドライバーの勤務地・既存分と被りなし）
const AREAS = [
  { pref: '東京都', city: '世田谷区', district: '太子堂' },
  { pref: '東京都', city: '中野区', district: '弥生町' },
  { pref: '東京都', city: '北区', district: '赤羽南' },
  { pref: '東京都', city: '品川区', district: '北品川' },
  { pref: '東京都', city: '大田区', district: '仲池上' },
  { pref: '東京都', city: '杉並区', district: '和田' },
  { pref: '東京都', city: '板橋区', district: '中台' },
  { pref: '東京都', city: '江戸川区', district: '東小松川' },
  { pref: '東京都', city: '江東区', district: '枝川' },
  { pref: '東京都', city: '練馬区', district: '春日町' },
  { pref: '東京都', city: '荒川区', district: '東尾久' },
  { pref: '東京都', city: '葛飾区', district: '高砂' },
  { pref: '東京都', city: '足立区', district: '皿沼' },
  { pref: '東京都', city: '目黒区', district: '下目黒' },
  { pref: '東京都', city: '世田谷区', district: '桜新町' },
];
...
for (let i = 0; i < AREAS.length; i++) {
  ...
  const _v = vary.build('st_haisou', areaLabel);
...
console.log(`\n完了: ${created}件作成（Style501・配送ドライバー・東京都15件(第2弾)）`);
