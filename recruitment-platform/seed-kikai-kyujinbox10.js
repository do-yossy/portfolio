'use strict';
// 機械オペレーター（鉄鋼・化学品）求人10件・第10弾（求人ボックス掲載・場所被りなし）
// 第1〜9弾・scripts各種・既存求人と被らない未使用の都道府県/都市を選定
// 冪等: 対象拠点のみ削除してから作り直す
...
// 第10弾10エリア（第1〜9弾・scripts各種・既存求人と被りなしの未使用都市）
// 既使用（除外）例: 神栖/太田/小山/甲賀/半田/和歌山/宇部/坂出/室蘭/相生（第9弾）、
//   市原/君津/平塚/碧南/大垣/高岡/周南/大分/新居浜/いわき（第8弾）、
//   日立/横須賀/磐田/安城/堺/尼崎/岡山/呉/久留米/鈴鹿（第7弾）、
//   大田区/長岡京/大和郡山/小松/坂井/甲斐/米子/阿南/南国/うるま（第6弾）、
//   鹿嶋/川崎/加古川/東海/延岡/新潟/袖ケ浦/釜石/仙台/秋田/千葉/豊田/明石/薩摩川内/大牟田/長崎/八戸/川口/富山/津/出雲/伊万里/八代/下関、
//   倉敷/福山/姫路/四日市/苫小牧/北九州/富士/盛岡/山形/松本/高松/大村/相模原/浜松/刈谷/田原/名古屋/東大阪 など
// 本弾: 北上/宇都宮/伊勢崎/長岡/掛川/岡崎/各務原/彦根/東広島/苅田（いずれも未使用・全都道府県も新規）
const AREAS = [
  { pref: '岩手県', city: '北上市',   plant: '北上川流域テクノポリス', specialty: '自動車部品・機械製造' },
  { pref: '栃木県', city: '宇都宮市', plant: '清原工業団地',           specialty: '輸送機器・機械製造' },
  { pref: '群馬県', city: '伊勢崎市', plant: '東毛工業地帯',           specialty: '自動車部品・機械製造' },
  { pref: '新潟県', city: '長岡市',   plant: '長岡機械金属工業地帯',   specialty: '精密機械・金属加工' },
  { pref: '静岡県', city: '掛川市',   plant: '掛川工業団地',           specialty: '輸送機器・機械製造' },
  { pref: '愛知県', city: '岡崎市',   plant: '岡崎工業地帯',           specialty: '自動車部品・機械製造' },
  { pref: '岐阜県', city: '各務原市', plant: '各務原テクノプラザ',     specialty: '航空機・機械製造' },
  { pref: '滋賀県', city: '彦根市',   plant: '湖東工業団地',           specialty: '機械・金属製品製造' },
  { pref: '広島県', city: '東広島市', plant: '東広島テクノタウン',     specialty: '半導体・機械製造' },
  { pref: '福岡県', city: '苅田町',   plant: '苅田臨海工業地帯',       specialty: '自動車・機械製造' },
];
...
if (del.changes > 0) console.log(`既存機械オペレーター（鉄鋼・化学品）第10弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（機械オペレーター（鉄鋼・化学品）第10弾・未使用都道府県10件）`);
