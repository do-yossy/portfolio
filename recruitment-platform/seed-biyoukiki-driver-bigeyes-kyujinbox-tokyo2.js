...
// 東京エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '台東区', district: '上野' },
  { pref: '東京都', city: '墨田区', district: '錦糸町' },
  { pref: '東京都', city: '文京区', district: '本郷' },
...
console.log(`\n完了: ${created}件作成（Bigeyes・美容機器運搬ドライバー・東京15件・本文は求人No.5148-4590-0003と同一）`);
