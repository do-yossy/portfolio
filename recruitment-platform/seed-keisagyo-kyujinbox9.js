'use strict';
// 工場軽作業スタッフ 求人10件・第9弾・全国（求人ボックス掲載）
// 月収30万円以上（月給30〜37万円）・第2〜8弾と被りなし
...
// 全国10エリア（工場軽作業第2〜8弾と被りなしの未使用都市）
// 本弾: 苫小牧,石巻,土浦,太田,春日部,木更津,厚木,小牧,舞鶴,大牟田（いずれも未使用・全都道府県も分散）
const AREAS = [
  { pref: '北海道',   city: '苫小牧市', facility: '食品・物流軽作業センター' },
  { pref: '宮城県',   city: '石巻市',   facility: '製造工場・部品組立ライン' },
  { pref: '茨城県',   city: '土浦市',   facility: '精密機器・食品加工工場' },
  { pref: '群馬県',   city: '太田市',   facility: '自動車部品・機械製造工場' },
  { pref: '埼玉県',   city: '春日部市', facility: '食品・日用品軽作業センター' },
  { pref: '千葉県',   city: '木更津市', facility: '化学・食品製造工場' },
  { pref: '神奈川県', city: '厚木市',   facility: '製造工場・部品組立ライン' },
  { pref: '愛知県',   city: '小牧市',   facility: '自動車部品・機械製造工場' },
  { pref: '京都府',   city: '舞鶴市',   facility: '食品・機械部品製造工場' },
  { pref: '福岡県',   city: '大牟田市', facility: '化学・食品製造工場' },
];
...
if (del.changes > 0) console.log(`既存工場軽作業スタッフ第9弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（${SALARY_INCOME}・工場軽作業スタッフ・全国10件・第9弾・応募情報を踏まえ内容強化）`);
