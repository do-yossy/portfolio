'use strict';
// ルート配送ドライバー（企業配送）求人15件・第8弾（求人ボックス掲載）
// 兵庫県神戸市各区＋兵庫県内他市（第1〜7弾と全エリア重複なし）
// 給与は「月給42万円〜62万円」
// 冪等: 対象拠点のみ削除してから作り直す
...
// 3弾大阪市: 中央区,北区,西区,淀川区,港区,住之江区,此花区,西淀川区,東成区,旭区,鶴見区,住吉区,西成区,大正区,東淀川区
// 4弾兵庫: 尼崎市,伊丹市,宝塚市,西宮市,芦屋市,神戸市東灘区
// 5弾大阪: 高槻市摂津富田,枚方市樟葉
// 6弾大阪市残り9区: 都島区,福島区,城東区,生野区,阿倍野区,東住吉区,平野区,浪速区,天王寺区
// 6弾大阪府: 豊中市,吹田市,茨木市,東大阪市,八尾市,守口市
// 7弾大阪府: 松原市,大東市,四條畷市,藤井寺市,羽曳野市,泉大津市,岸和田市,池田市,箕面市,摂津市,寝屋川市,堺市北区,堺市堺区,高槻市,枚方市
// 本弾: 神戸市各区（東灘区以外）＋兵庫県内他市
const AREAS = [
  { pref: '兵庫県', city: '神戸市', district: '灘区六甲道',   client: '食品・飲料メーカー' },
  { pref: '兵庫県', city: '神戸市', district: '中央区三宮',   client: '企業・商業施設向け日用品' },
  { pref: '兵庫県', city: '神戸市', district: '兵庫区兵庫',   client: '工場・倉庫向け資材' },
  { pref: '兵庫県', city: '神戸市', district: '長田区長田',   client: '食品・日用品卸売' },
  { pref: '兵庫県', city: '神戸市', district: '須磨区須磨',   client: '食品・飲料メーカー' },
  { pref: '兵庫県', city: '神戸市', district: '垂水区垂水',   client: '医療機器・日用品卸' },
  { pref: '兵庫県', city: '神戸市', district: '西区玉津',     client: '工場・物流センター向け' },
  { pref: '兵庫県', city: '神戸市', district: '北区鈴蘭台',   client: '食品・工業資材メーカー' },
  { pref: '兵庫県', city: '明石市',   district: '明石',       client: '食品・飲料メーカー' },
  { pref: '兵庫県', city: '加古川市', district: '加古川',     client: '工場・倉庫向け資材' },
  { pref: '兵庫県', city: '姫路市',   district: '姫路',       client: '食品・工業用品メーカー' },
  { pref: '兵庫県', city: '高砂市',   district: '高砂',       client: '企業・事業所向け日用品' },
  { pref: '兵庫県', city: '川西市',   district: '川西',       client: '食品・日用品卸売' },
  { pref: '兵庫県', city: '三田市',   district: '三田',       client: '医療機器・事業所向け用品' },
  { pref: '京都府', city: '向日市',   district: '向日',       client: '食品・飲料メーカー' },
];
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第8弾・神戸市各区＋兵庫県内他市15件）`);
