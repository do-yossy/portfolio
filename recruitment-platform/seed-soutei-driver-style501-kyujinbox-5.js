...
// 東京都内10エリア第3弾（Style501 送迎ドライバー・既存分と被りなし）
const AREAS = [
  { pref: '東京都', city: '世田谷区', district: '北沢' },
  { pref: '東京都', city: '中野区', district: '上高田' },
  { pref: '東京都', city: '品川区', district: '西品川' },
  { pref: '東京都', city: '大田区', district: '雪谷' },
  { pref: '東京都', city: '杉並区', district: '方南' },
  { pref: '東京都', city: '板橋区', district: '徳丸' },
  { pref: '東京都', city: '江戸川区', district: '瑞江' },
  { pref: '東京都', city: '練馬区', district: '田柄' },
  { pref: '東京都', city: '葛飾区', district: '柴又' },
  { pref: '東京都', city: '足立区', district: '江北' },
];
...
console.log(`\n完了: ${created}件作成（Style501・送迎ドライバー・東京都10件(第3弾)）`);
