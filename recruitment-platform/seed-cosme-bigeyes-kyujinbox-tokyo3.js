...
const AREAS = [
  { pref: '東京都', city: '大田区', district: '大森南' },
  { pref: '東京都', city: '江戸川区', district: '西葛西' },
  { pref: '東京都', city: '足立区', district: '扇' },
  { pref: '東京都', city: '葛飾区', district: '新宿' },
  { pref: '東京都', city: '板橋区', district: '三園' },
  { pref: '東京都', city: '江東区', district: '枝川' },
  { pref: '東京都', city: '墨田区', district: '文花' },
  { pref: '東京都', city: '北区', district: '堀船' },
  { pref: '東京都', city: '品川区', district: '東大井' },
...
console.log(`\n完了: ${created}件作成（Bigeyes・コスメ製造スタッフ・東京10件(第3弾)・本文は求人No.5148-4590-0005と同一）`);
