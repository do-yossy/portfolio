...
const AREAS = [
  { pref: '東京都', city: '世田谷区', district: '喜多見' },
  { pref: '東京都', city: '中野区', district: '江古田' },
  { pref: '東京都', city: '品川区', district: '東中延' },
  { pref: '東京都', city: '大田区', district: '馬込' },
  { pref: '東京都', city: '杉並区', district: '浜田山' },
  { pref: '東京都', city: '板橋区', district: '志村坂上' },
  { pref: '東京都', city: '江戸川区', district: '松島' },
  { pref: '東京都', city: '練馬区', district: '富士見台' },
  { pref: '東京都', city: '葛飾区', district: 'お花茶屋' },
  { pref: '東京都', city: '足立区', district: '保木間' },
];
...
console.log(`\n完了: ${created}件作成（Style501・送迎ドライバー・東京都10件(第4弾)）`);
