'use strict';
// ルート配送ドライバー（企業配送）求人15件・第22弾（求人ボックス掲載）
...
// 本弾: 兵庫県(阪神間)・京都府(大阪寄り)の未使用エリア15件。
const AREAS = [
  { pref: '兵庫県', city: '尼崎市', district: '潮江', client: '食品・飲料メーカー' },
  { pref: '兵庫県', city: '西宮市', district: '甲子園', client: '企業・商業施設向け日用品' },
  { pref: '兵庫県', city: '伊丹市', district: '昆陽', client: '工場・倉庫向け資材' },
  { pref: '兵庫県', city: '宝塚市', district: '中州', client: '食品・日用品卸売' },
  { pref: '兵庫県', city: '川西市', district: '火打', client: '医療機器・事業所向け用品' },
  { pref: '兵庫県', city: '芦屋市', district: '浜風町', client: '企業・商業施設向け日用品' },
  { pref: '兵庫県', city: '三田市', district: 'けやき台', client: '工場・物流センター向け' },
  { pref: '兵庫県', city: '神戸市', district: '東灘区深江本町', client: '食品・工業用品メーカー' },
  { pref: '京都府', city: '長岡京市', district: '開田', client: '食品・飲料メーカー' },
  { pref: '京都府', city: '向日市', district: '寺戸町', client: '工場・倉庫向け資材' },
  { pref: '京都府', city: '京田辺市', district: '三山木', client: '食品・日用品卸売' },
  { pref: '京都府', city: '八幡市', district: '男山', client: '企業・商業施設向け日用品' },
  { pref: '京都府', city: '久御山町', district: '田井', client: '医療機器・事業所向け用品' },
  { pref: '京都府', city: '城陽市', district: '久世', client: '食品・工業資材メーカー' },
  { pref: '京都府', city: '宇治市', district: '小倉町', client: '食品・飲料メーカー' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第22弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第22弾・兵庫県/京都府(大阪寄り)の未使用エリア15件・応募情報を踏まえ内容強化）`);
