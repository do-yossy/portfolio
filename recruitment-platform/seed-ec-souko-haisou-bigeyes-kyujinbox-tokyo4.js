...
// 東京エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '江東区', district: '青海' },
  { pref: '東京都', city: '大田区', district: '昭和島' },
  { pref: '東京都', city: '江戸川区', district: '中葛西' },
  { pref: '東京都', city: '足立区', district: '宮城' },
];
...
console.log(`\n完了: ${created}件作成（Bigeyes・EC倉庫配送スタッフ・東京4件・本文は求人No.5148-4590-0002と同一）`);
