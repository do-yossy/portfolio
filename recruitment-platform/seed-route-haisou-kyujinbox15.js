'use strict';
// ルート配送ドライバー（企業配送）求人15件・第15弾（求人ボックス掲載）
// 大阪市内の未使用エリア（第7〜14弾と勤務地の重複なし・別地名で構成）
// 給与は「月給42万円〜62万円」
// 冪等: 対象拠点のみ削除してから作り直す
...
// 本弾: 大阪市内の未使用エリア。第7〜14弾で使った地名とは別の町名で構成（勤務地文字列の重複なし）。
const AREAS = [
  { pref: '大阪府', city: '大阪市', district: '都島区友渕町',   client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '福島区海老江',   client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '此花区伝法',     client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '西区京町堀',     client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '港区市岡',       client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市', district: '大正区平尾',     client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '天王寺区大道',   client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市', district: '浪速区日本橋',   client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '西淀川区大和田', client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '大阪市', district: '東淀川区豊新',   client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '東成区深江',     client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '生野区桃谷',     client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '旭区森小路',     client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '城東区中浜',     client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '阿倍野区阪南町', client: '工場・倉庫向け資材' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第15弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第15弾・大阪市内の未使用エリア15件）`);
