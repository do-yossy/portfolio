'use strict';
// ルート配送ドライバー（企業配送）求人15件・第23弾（求人ボックス掲載）
...
const AREAS = [
  { pref: '大阪府', city: '大阪市', district: '都島区高倉町', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '都島区内代町', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '福島区吉野', client: '化学・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市', district: '此花区島屋', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市', district: '西区江戸堀', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '西成区玉出', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '西成区花園北', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '平野区加美', client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '大阪市', district: '平野区長吉', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '東住吉区今川', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '東住吉区湯里', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '住吉区長居', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '阿倍野区昭和町', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '鶴見区横堤', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '生野区新今里', client: '工場・倉庫向け資材' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第23弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第23弾・大阪市内の未使用エリア15件・応募情報を踏まえ内容強化）`);
