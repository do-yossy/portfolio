'use strict';
// ルート配送ドライバー（企業配送）求人15件・第20弾（求人ボックス掲載）
...
// 本弾: 大阪市内の未使用エリア（第7〜19弾で使った地名とは別の町名で構成）。
const AREAS = [
  { pref: '大阪府', city: '大阪市', district: '北区堂島', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '北区中津', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '中央区島之内', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '西区川口', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '港区海岸通', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市', district: '大正区南恩加島', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '浪速区稲荷', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市', district: '西淀川区姫里', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '淀川区塚本', client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '大阪市', district: '東淀川区小松', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '東成区神路', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '生野区林寺', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '旭区中宮', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '城東区永田', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '鶴見区放出東', client: '工場・倉庫向け資材' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第20弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第20弾・大阪市内の未使用エリア15件・応募情報を踏まえ内容強化）`);
