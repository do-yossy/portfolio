...
// 東京エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '渋谷区', district: '恵比寿' },
  { pref: '東京都', city: '新宿区', district: '西新宿' },
  { pref: '東京都', city: '千代田区', district: '神田' },
...
console.log(`\n完了: ${created}件作成（Bigeyes・コスメ配送ドライバー・東京15件・本文は求人No.5148-4590-0001と同一）`);
