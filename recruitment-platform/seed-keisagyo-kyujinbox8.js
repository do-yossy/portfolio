'use strict';
// 工場軽作業スタッフ 求人10件・第8弾・全国（求人ボックス掲載）
// 月収30万円以上（月給30〜37万円）・第1〜7弾と被りなし
...
// 全国10エリア（軽作業第1〜7弾・機械オペレーター全弾と被りなし）
// 本弾: 帯広,横手,白河,高崎,柏崎,飯田,富士,四日市,倉敷,下関（いずれも未使用）
const AREAS = [
  { pref: '北海道',   city: '帯広市',       facility: '食品・物流軽作業センター' },
  { pref: '秋田県',   city: '横手市',       facility: '製造工場・部品組立ライン' },
  { pref: '福島県',   city: '白河市',       facility: '精密機器・食品加工工場' },
  { pref: '群馬県',   city: '高崎市',       facility: '食品・機械部品製造工場' },
  { pref: '新潟県',   city: '柏崎市',       facility: '製造工場・部品組立ライン' },
  { pref: '長野県',   city: '飯田市',       facility: '食品・機械部品製造工場' },
  { pref: '静岡県',   city: '富士市',       facility: '製造工場・部品組立ライン' },
  { pref: '三重県',   city: '四日市市',     facility: '食品・日用品軽作業センター' },
  { pref: '岡山県',   city: '倉敷市',       facility: '化学・食品製造工場' },
  { pref: '山口県',   city: '下関市',       facility: '食品加工・物流軽作業センター' },
];
...
if (del.changes > 0) console.log(`既存工場軽作業スタッフ第8弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（${SALARY_INCOME}・工場軽作業スタッフ・全国10件・第8弾・応募情報を踏まえ内容強化）`);
