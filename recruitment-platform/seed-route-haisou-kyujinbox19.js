'use strict';
// ルート配送ドライバー（企業配送）求人15件・第19弾（求人ボックス掲載）
// 全国の主要物流エリア（第7〜18弾＝関西中心と勤務地の重複なし・関西以外で構成）
// 給与は「月給42万円〜62万円」
...
// 本弾: 全国の主要物流エリア（第7〜18弾で使った関西エリアとは別地域で構成）。
const AREAS = [
  { pref: '北海道',   city: '札幌市',   district: '白石区流通センター', client: '食品・飲料メーカー' },
  { pref: '宮城県',   city: '仙台市',   district: '宮城野区扇町',       client: '工場・倉庫向け資材' },
  { pref: '東京都',   city: '大田区',   district: '平和島',             client: '企業・商業施設向け日用品' },
  { pref: '東京都',   city: '江東区',   district: '新木場',             client: '食品・日用品卸売' },
  { pref: '神奈川県', city: '横浜市',   district: '港北区新横浜',       client: '食品・工業用品メーカー' },
  { pref: '神奈川県', city: '川崎市',   district: '川崎区東扇島',       client: '医療機器・事業所向け用品' },
  { pref: '埼玉県',   city: 'さいたま市', district: '大宮区',           client: '工場・物流センター向け' },
  { pref: '千葉県',   city: '千葉市',   district: '美浜区中瀬',         client: '食品・日用品卸売' },
  { pref: '愛知県',   city: '名古屋市', district: '港区',               client: '食品・工業資材メーカー' },
  { pref: '愛知県',   city: '名古屋市', district: '中川区',             client: '食品・飲料メーカー' },
  { pref: '静岡県',   city: '浜松市',   district: '中央区',             client: '工場・倉庫向け資材' },
  { pref: '広島県',   city: '広島市',   district: '西区商工センター',   client: '食品・日用品卸売' },
  { pref: '岡山県',   city: '岡山市',   district: '北区大内田',         client: '企業・商業施設向け日用品' },
  { pref: '福岡県',   city: '福岡市',   district: '東区箱崎ふ頭',       client: '医療機器・事業所向け用品' },
  { pref: '福岡県',   city: '北九州市', district: '小倉北区',           client: '工場・倉庫向け資材' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第19弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第19弾・全国の主要物流エリア15件・応募情報を踏まえ内容強化）`);
