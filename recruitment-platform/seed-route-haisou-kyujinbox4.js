'use strict';
// ルート配送ドライバー（企業配送）求人10件・第4弾（求人ボックス掲載・阪神間の兵庫県・場所被りなし）
// 法人・事業所への固定ルート配送（食品・飲料・日用品・医療機器等）
// 給与は掲載写真の「月給42万円〜62万円」に合わせる
// 第1弾(大阪府郊外+兵庫)・第2弾(大阪府+兵庫)・第3弾(大阪市内15区)と全エリア重複なし
// 冪等: 対象拠点のみ削除してから作り直す
...
// 1弾兵庫: 神戸中央区三宮,神戸西区伊川谷,加古川,高砂,明石
// 2弾大阪: 門真古川橋,泉南樽井,堺東区,堺南区,阪南尾崎,島本水無瀬,熊取
// 2弾兵庫: 神戸垂水区垂水,神戸須磨区鷹取,神戸兵庫区湊川,神戸長田区新長田,三木,小野,姫路,たつの竜野
// 3弾大阪市: 中央区船場,北区中津,西区阿波座,淀川区新大阪,港区弁天町,住之江区南港,此花区西九条,
//          西淀川区御幣島,東成区今里,旭区千林,鶴見区横堤,住吉区我孫子,西成区玉出,大正区鶴町,東淀川区上新庄
// 本弾は阪神間（大阪寄り）の兵庫県エリアで全エリア重複なし
const AREAS = [
  { pref: '兵庫県', city: '尼崎市', district: '立花',       client: '食品・日用品メーカー' },
  { pref: '兵庫県', city: '西宮市', district: '西宮北口',   client: '医療機器・事業所向け用品' },
  { pref: '兵庫県', city: '伊丹市', district: '昆陽',       client: '食品・飲料メーカー' },
  { pref: '兵庫県', city: '宝塚市', district: '売布',       client: '企業・事業所向け日用品' },
  { pref: '兵庫県', city: '川西市', district: '川西池田',   client: '食品・工業資材メーカー' },
  { pref: '兵庫県', city: '芦屋市', district: '打出',       client: '商業施設・企業向け' },
  { pref: '兵庫県', city: '神戸市', district: '北区鈴蘭台', client: '工場・物流センター向け' },
  { pref: '兵庫県', city: '神戸市', district: '東灘区住吉', client: '食品・医療用品卸' },
  { pref: '兵庫県', city: '三田市', district: '三田本町',   client: '工場・企業向け資材' },
  { pref: '兵庫県', city: '西脇市', district: '西脇',       client: '食品・工業用品メーカー' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー（企業配送）第4弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第4弾・阪神間の兵庫県10件・${SALARY_INCOME}・写真付き）`);
