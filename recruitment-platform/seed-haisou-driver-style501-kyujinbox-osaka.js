...
// 大阪府内15エリア（Style501 配送ドライバー・大阪・既存分と被りなし）
const AREAS = [
  { pref: '大阪府', city: '大阪市', district: '生野区巽' },
  { pref: '大阪府', city: '大阪市', district: '平野区喜連' },
  { pref: '大阪府', city: '大阪市', district: '東住吉区駒川' },
  { pref: '大阪府', city: '大阪市', district: '住吉区長居' },
  { pref: '大阪府', city: '大阪市', district: '西成区玉出' },
  { pref: '大阪府', city: '堺市', district: '堺区中瓦町' },
  { pref: '大阪府', city: '堺市', district: '北区新金岡町' },
  ...
  { pref: '大阪府', city: '豊中市', district: '庄内幸町' },
  { pref: '大阪府', city: '枚方市', district: '香里ケ丘' },
  { pref: '大阪府', city: '寝屋川市', district: '香里本通町' },
];
...
console.log(`\n完了: ${created}件作成（Style501・配送ドライバー・大阪府15件）`);
