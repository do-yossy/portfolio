'use strict';
// ルート配送ドライバー（企業配送）求人15件・第2弾（求人ボックス掲載・大阪府7＋兵庫県8）
...
// 除外済みエリア（高時給1弾・2弾大阪・兵庫、ルート1弾大阪・兵庫、既存除外）:
// 高時給1弾大阪: 豊中市岡町, 吹田市江坂, 茨木市南茨木, 高槻市富田, 枚方市招提,
//        八尾市近鉄八尾, 寝屋川市香里園, 東大阪市布施, 守口市大日, 松原市河内松原, 堺市堺区
// 高時給1弾兵庫: 尼崎市武庫之荘, 西宮市甲子園, 伊丹市伊丹, 宝塚市逆瀬川
// 高時給2弾大阪: 池田市石橋, 箕面市牧落, 摂津市千里丘, 大東市住道, 四條畷市四条畷,
//        藤井寺市道明寺, 羽曳野市古市, 堺市中区, 泉大津市泉大津, 岸和田市岸和田
// 高時給2弾兵庫: 川西市川西能勢口, 芦屋市芦屋, 神戸市東灘区魚崎, 神戸市灘区六甲道, 三田市三田
// ルート1弾大阪: 交野市星田, 柏原市柏原, 富田林市富田林, 河内長野市河内長野,
//        大阪狭山市大阪狭山, 和泉市和泉中央, 高石市高石, 堺市西区, 泉佐野市泉佐野, 貝塚市貝塚
// ルート1弾兵庫: 神戸市中央区三宮, 神戸市西区伊川谷, 加古川市加古川, 高砂市高砂, 明石市明石
// 既存除外: 大阪市全24区, 堺市北区
const AREAS = [
  { pref: '大阪府', city: '門真市',   district: '古川橋',     client: '食品・日用品メーカー' },
  { pref: '大阪府', city: '泉南市',   district: '樽井',       client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '堺市',     district: '東区',       client: '工場・企業向け資材' },
  { pref: '大阪府', city: '堺市',     district: '南区',       client: '食品・医療用品卸' },
  { pref: '大阪府', city: '阪南市',   district: '尾崎',       client: '企業・事業所向け日用品' },
  { pref: '大阪府', city: '島本町',   district: '水無瀬',     client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '熊取町',   district: '熊取',       client: '工場・物流センター向け' },
  { pref: '兵庫県', city: '神戸市',   district: '垂水区垂水', client: '商業施設・企業向け' },
  { pref: '兵庫県', city: '神戸市',   district: '須磨区鷹取', client: '食品・日用品卸' },
  { pref: '兵庫県', city: '神戸市',   district: '兵庫区湊川', client: '医療機器・事業所向け' },
  { pref: '兵庫県', city: '神戸市',   district: '長田区新長田', client: '食品・飲料メーカー' },
  { pref: '兵庫県', city: '三木市',   district: '三木',       client: '工場・企業向け資材' },
  { pref: '兵庫県', city: '小野市',   district: '小野',       client: '食品・工業資材' },
  { pref: '兵庫県', city: '姫路市',   district: '姫路',       client: '企業・工場向け食品・資材' },
  { pref: '兵庫県', city: 'たつの市', district: '竜野',       client: '食品・工業用品メーカー' },
];
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第2弾・大阪府7＋兵庫県8・${SALARY_INCOME}・写真付き）`);
