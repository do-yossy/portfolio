'use strict';
// ルート配送ドライバー（企業配送）求人15件・第3弾（求人ボックス掲載・大阪市内15区・場所被りなし）
// 法人・事業所への固定ルート配送（食品・飲料・日用品・医療機器等）
// 給与は掲載写真の「月給42万円〜62万円」に合わせる
// 第1弾・第2弾は大阪府郊外市＋兵庫県のため、本弾は大阪市内の区で重複なし
// 冪等: 対象拠点のみ削除してから作り直す
...
// ルート2弾大阪: 門真市古川橋, 泉南市樽井, 堺市東区, 堺市南区, 阪南市尾崎, 島本町水無瀬, 熊取町熊取
// 本弾は大阪市内の主要区（オフィス・物流拠点）を選定し全エリア重複なし
const AREAS = [
  { pref: '大阪府', city: '大阪市', district: '中央区船場',   client: 'オフィス・商業施設向け文具・備品' },
  { pref: '大阪府', city: '大阪市', district: '北区中津',     client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '西区阿波座',   client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市', district: '淀川区新大阪', client: '企業・オフィス向け資材' },
  { pref: '大阪府', city: '大阪市', district: '港区弁天町',   client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市', district: '住之江区南港', client: '物流倉庫・商業施設向け' },
  { pref: '大阪府', city: '大阪市', district: '此花区西九条', client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '大阪市', district: '西淀川区御幣島', client: '工場・企業向け資材' },
  { pref: '大阪府', city: '大阪市', district: '東成区今里',   client: '食品・日用品卸' },
  { pref: '大阪府', city: '大阪市', district: '旭区千林',     client: '企業・事業所向け日用品' },
  { pref: '大阪府', city: '大阪市', district: '鶴見区横堤',   client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市', district: '住吉区我孫子', client: '医療・介護用品卸' },
  { pref: '大阪府', city: '大阪市', district: '西成区玉出',   client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市', district: '大正区鶴町',   client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市', district: '東淀川区上新庄', client: '企業・工場向け食品・資材' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー（企業配送）第3弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第3弾・大阪市内15区・${SALARY_INCOME}・写真付き）`);
