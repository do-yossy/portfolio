...
// 東京エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '渋谷区', district: '神宮前' },
  { pref: '東京都', city: '港区', district: '赤坂' },
  { pref: '東京都', city: '新宿区', district: '新宿' },
];
...
console.log(`\n完了: ${created}件作成（Bigeyes・ヘアサロン向け配送スタッフ・東京3件・本文は求人No.5148-4590-0004と同一）`);
