...
// 会社: BigEyesコーポレーション株式会社(bg) / 給与: 月給40万円〜45万円（夜勤専属 22:00〜7:00）
...
const SALARY_DETAIL = '月給400,000円〜450,000円';

// 東京エリア（Bigeyes）
const AREAS = [
  { pref: '東京都', city: '江東区', district: '塩浜' },
  { pref: '東京都', city: '大田区', district: '大森本町' },
  { pref: '東京都', city: '江戸川区', district: '松江' },
  { pref: '東京都', city: '足立区', district: '梅島' },
];
...
for (let i = 0; i < AREAS.length; i++) {
  ...
  const catchcopy = `夜勤専属で高収入！倉庫内での商品管理・積み込みと、取引先への配送を担当するお仕事です。月給40万円以上・普通免許OK・完全週休二日制・固定ルート中心。車両費用はすべて会社負担で、未経験から安心してスタートできます。`;
...
console.log(`\n完了: ${created}件作成（Bigeyes・EC倉庫配送スタッフ・東京4件(第3弾)・本文は求人No.5148-4590-0002と同一）`);
