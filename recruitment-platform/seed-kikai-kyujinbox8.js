'use strict';
// 機械オペレーター（鉄鋼・化学品）求人10件・第8弾（求人ボックス掲載・場所被りなし）
// 第1〜7弾・既存求人と被らない未使用の都府県を選定
// 冪等: 対象拠点のみ削除してから作り直す
...
// 第8弾10エリア（第1〜7弾・既存求人と被りなしの未使用都市）
// 既使用（除外）: 日立/横須賀/磐田/安城/堺/尼崎/岡山/呉/久留米/鈴鹿（第7弾）、
//   大田区/長岡京/大和郡山/小松/坂井/甲斐/米子/阿南/南国/うるま（第6弾）、
//   つくば/鹿嶋/川崎/相模原/富士/浜松/刈谷/豊田/田原/名古屋/東海/東大阪/姫路/加古川/明石/倉敷/福山/北九州/大牟田/四日市/津 など
// 本弾: 市原/君津/平塚/碧南/大垣/高岡/周南/大分/新居浜/いわき（いずれも未使用）
const AREAS = [
  { pref: '千葉県',   city: '市原市',     plant: '京葉臨海工業地帯',     specialty: '石油化学品・機械製造' },
  { pref: '千葉県',   city: '君津市',     plant: '君津臨海工業地帯',     specialty: '鉄鋼・機械製造' },
  { pref: '神奈川県', city: '平塚市',     plant: '湘南工業地帯',         specialty: '輸送機器・機械製造' },
  { pref: '愛知県',   city: '碧南市',     plant: '衣浦臨海工業地帯',     specialty: '鉄鋼・化学品製造' },
  { pref: '岐阜県',   city: '大垣市',     plant: '大垣工業地帯',         specialty: '化学品・機械製造' },
  { pref: '富山県',   city: '高岡市',     plant: '高岡工業地帯',         specialty: '金属・機械製造' },
  { pref: '山口県',   city: '周南市',     plant: '周南コンビナート',     specialty: '化学品・機械製造' },
  { pref: '大分県',   city: '大分市',     plant: '大分臨海工業地帯',     specialty: '鉄鋼・化学品製造' },
  { pref: '愛媛県',   city: '新居浜市',   plant: '新居浜工業地帯',       specialty: '化学品・非鉄金属製造' },
  { pref: '福島県',   city: 'いわき市',   plant: '常磐臨海工業地帯',     specialty: '化学品・機械製造' },
];
...
if (del.changes > 0) console.log(`既存機械オペレーター（鉄鋼・化学品）第8弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（機械オペレーター（鉄鋼・化学品）第8弾・未使用都府県10件）`);
