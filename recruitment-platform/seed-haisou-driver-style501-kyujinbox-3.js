...
const AREAS = [
  { pref: '東京都', city: '世田谷区', district: '下北沢' },
  { pref: '東京都', city: '中野区', district: '野方' },
  { pref: '東京都', city: '北区', district: '田端' },
  { pref: '東京都', city: '品川区', district: '大崎' },
  { pref: '東京都', city: '大田区', district: '羽田' },
  { pref: '東京都', city: '杉並区', district: '高井戸' },
  { pref: '東京都', city: '板橋区', district: '東新町' },
  { pref: '東京都', city: '江戸川区', district: '一之江' },
  { pref: '東京都', city: '江東区', district: '豊洲' },
  { pref: '東京都', city: '練馬区', district: '関町' },
  { pref: '東京都', city: '荒川区', district: '西尾久' },
  { pref: '東京都', city: '葛飾区', district: '堀切' },
  { pref: '東京都', city: '足立区', district: '舎人' },
  { pref: '東京都', city: '目黒区', district: '中央町' },
  { pref: '東京都', city: '世田谷区', district: '成城' },
];
