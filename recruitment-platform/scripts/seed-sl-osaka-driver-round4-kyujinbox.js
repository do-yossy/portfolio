...
'use strict';
/**
 * 合同会社スマイルライフ（sl）／配送・送迎ドライバー正社員求人（求人ボックス掲載）— 大阪バッチ・第4弾25件
 *
 * 2026-09-25、日次の求人ボックス求人作成に伴う追加バッチ。既存64件（第1〜3弾、丁目表記未使用）
 * と重複しないよう、第3弾と同一エリアの1丁目表記で構成。内容方針・画像/rewardingの扱いは第1〜3弾と同一。
 *
 * 冪等化: 自分のタイトル（company='sl'）のみ削除してから投入。
 *
 * 実行: node --experimental-sqlite scripts/seed-sl-osaka-driver-round4-kyujinbox.js
 */
...
// 既存64件（第1〜3弾、丁目表記未使用）と重複しない新規25エリア（第3弾と同一ベースの1丁目表記）
const AREAS = [
  { area: '大阪市西成区岸里1丁目',     city: '大阪府大阪市西成区岸里1丁目',     jobType: '配送ドライバー' },
  { area: '大阪市住之江区南港1丁目',   city: '大阪府大阪市住之江区南港1丁目',   jobType: '配送ドライバー' },
  { area: '大阪市港区磯路1丁目',       city: '大阪府大阪市港区磯路1丁目',       jobType: '配送ドライバー' },
  { area: '大阪市大正区三軒家東1丁目', city: '大阪府大阪市大正区三軒家東1丁目', jobType: '配送ドライバー' },
  { area: '大阪市此花区春日出中1丁目', city: '大阪府大阪市此花区春日出中1丁目', jobType: '配送ドライバー' },
  { area: '大阪市福島区野田1丁目',     city: '大阪府大阪市福島区野田1丁目',     jobType: '配送ドライバー' },
  { area: '堺市堺区宿院町1丁目',       city: '大阪府堺市堺区宿院町1丁目',       jobType: '配送ドライバー' },
  { area: '堺市北区新金岡町1丁目',     city: '大阪府堺市北区新金岡町1丁目',     jobType: '配送ドライバー' },
  { area: '東大阪市長田1丁目',         city: '大阪府東大阪市長田1丁目',         jobType: '配送ドライバー' },
  { area: '枚方市岡東町1丁目',         city: '大阪府枚方市岡東町1丁目',         jobType: '配送ドライバー' },
  { area: '八尾市若林町1丁目',         city: '大阪府八尾市若林町1丁目',         jobType: '配送ドライバー' },
  { area: '寝屋川市早子町1丁目',       city: '大阪府寝屋川市早子町1丁目',       jobType: '配送ドライバー' },
  { area: '守口市金田町1丁目',         city: '大阪府守口市金田町1丁目',         jobType: '配送ドライバー' },
  { area: '門真市速見町1丁目',         city: '大阪府門真市速見町1丁目',         jobType: '送迎ドライバー' },
  { area: '松原市阿保1丁目',           city: '大阪府松原市阿保1丁目',           jobType: '送迎ドライバー' },
  { area: '藤井寺市岡1丁目',           city: '大阪府藤井寺市岡1丁目',           jobType: '送迎ドライバー' },
  { area: '尼崎市塚口本町1丁目',       city: '兵庫県尼崎市塚口本町1丁目',       jobType: '送迎ドライバー' },
  { area: '西宮市甲子園町1丁目',       city: '兵庫県西宮市甲子園町1丁目',       jobType: '送迎ドライバー' },
  { area: '伊丹市中央1丁目',           city: '兵庫県伊丹市中央1丁目',           jobType: '送迎ドライバー' },
  { area: '宝塚市逆瀬川1丁目',         city: '兵庫県宝塚市逆瀬川1丁目',         jobType: '送迎ドライバー' },
  { area: '川西市栄町1丁目',           city: '兵庫県川西市栄町1丁目',           jobType: '送迎ドライバー' },
  { area: '芦屋市業平町1丁目',         city: '兵庫県芦屋市業平町1丁目',         jobType: '送迎ドライバー' },
  { area: '川辺郡猪名川町白金1丁目',   city: '兵庫県川辺郡猪名川町白金1丁目',   jobType: '送迎ドライバー' },
  { area: '京都市伏見区深草1丁目',     city: '京都府京都市伏見区深草1丁目',     jobType: '送迎ドライバー' },
  { area: '京都市南区上鳥羽1丁目',     city: '京都府京都市南区上鳥羽1丁目',     jobType: '送迎ドライバー' },
];
...
function buildDescription(a, kind) {
  ...
  const intro = pick(INTRO, a.area, `sl4:${kind}:intro`)(a.area);
...
const JOBS = AREAS.map(a => {
  ...
  const title = `【${a.area}】${pick(TITLE_POOL, a.area, `sl4:${kind}:title`)}`;
  return {
...
async function main() {
  console.log(`\n🚚 スマイルライフ 配送・送迎ドライバー求人 第4弾（求人ボックス・大阪/京都/兵庫）${JOBS.length}件 を登録します...\n`);
