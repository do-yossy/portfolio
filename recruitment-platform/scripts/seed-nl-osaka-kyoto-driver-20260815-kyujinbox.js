...
'use strict';
/**
 * 株式会社NOWLIVE（nl）／配送・ルートドライバー 今日のバッチ（2026-08-15・求人ボックス掲載）— 大阪・京都
 ...
 *
 * 実行: node --experimental-sqlite scripts/seed-nl-osaka-kyoto-driver-20260815-kyujinbox.js
 */
...
const AREAS = [
  { area: '大阪市住吉区東粉浜3丁目',   city: '大阪府大阪市住吉区東粉浜3丁目' },
  { area: '大阪市東住吉区田辺4丁目',   city: '大阪府大阪市東住吉区田辺4丁目' },
  { area: '大阪市平野区喜連西4丁目',   city: '大阪府大阪市平野区喜連西4丁目' },
  { area: '大阪市西成区千本中1丁目',   city: '大阪府大阪市西成区千本中1丁目' },
  { area: '大阪市港区海岸通2丁目',   city: '大阪府大阪市港区海岸通2丁目' },
  { area: '大阪市大正区三軒家西2丁目',   city: '大阪府大阪市大正区三軒家西2丁目' },
  { area: '大阪市此花区伝法4丁目',   city: '大阪府大阪市此花区伝法4丁目' },
  { area: '大阪市淀川区東三国2丁目',   city: '大阪府大阪市淀川区東三国2丁目' },
  { area: '大阪市東淀川区淡路2丁目',   city: '大阪府大阪市東淀川区淡路2丁目' },
  { area: '大阪市旭区高殿5丁目',   city: '大阪府大阪市旭区高殿5丁目' },
  { area: '京都市中京区西大路',   city: '京都府京都市中京区西大路' },
  { area: '京都市下京区中堂寺西寺町',   city: '京都府京都市下京区中堂寺西寺町' },
  { area: '京都市南区久世高田町',   city: '京都府京都市南区久世高田町' },
  { area: '京都市右京区嵯峨野',   city: '京都府京都市右京区嵯峨野' },
  { area: '京都市左京区浄土寺',   city: '京都府京都市左京区浄土寺' },
  { area: '京都市東山区四条通',   city: '京都府京都市東山区四条通' },
  { area: '京都市山科区小野',   city: '京都府京都市山科区小野' },
  { area: '京都市伏見区桃山町養斉',   city: '京都府京都市伏見区桃山町養斉' },
  { area: '京都市北区鷹峯',   city: '京都府京都市北区鷹峯' },
  { area: '宇治市木幡',   city: '京都府宇治市木幡' },
  { area: '亀岡市曽我部町',   city: '京都府亀岡市曽我部町' },
  { area: '城陽市中',   city: '京都府城陽市中' },
  { area: '久世郡久御山町',   city: '京都府久世郡久御山町' },
  { area: '長岡京市粟生',   city: '京都府長岡京市粟生' },
  { area: '木津川市木津川台',   city: '京都府木津川市木津川台' },
];
