...
'use strict';
/**
 * 軽配送ドライバー求人 15件（大阪・正社員・月収39万円以上）
 * ※ 既存の「軽貨物ドライバー」「EC商品の軽配送」と重複しないエリアで作成
 * 実行: node --experimental-sqlite scripts/seed-keihaisou-39man.js
 */
...
// 既存で使われていない大阪府内エリア15か所
const AREAS = [
  { area: '箕面市・牧落・桜井',    city: '大阪府箕面市',    shift: '8:00〜17:00', vol: '60〜90件',  note: '閑静な住宅街で駐車環境が良く、効率よく配達できる' },
  { area: '池田市・石橋・川西北', city: '大阪府池田市',    shift: '8:00〜17:00', vol: '55〜85件',  note: '一戸建てが多く落ち着いて配達できるエリア' },
  { area: '交野市・星田・私市',   city: '大阪府交野市',    shift: '8:00〜17:00', vol: '55〜80件',  note: '緑豊かな住宅地でストレス少なく走れる' },
  { area: '四條畷市・忍ヶ丘',    city: '大阪府四條畷市',  shift: '8:00〜17:00', vol: '55〜80件',  note: '丘陵住宅地で在宅率が高め' },
  { area: '大東市・野崎・住道',   city: '大阪府大東市',    shift: '8:00〜17:00', vol: '65〜90件',  note: 'マンション・一戸建て均等で配達しやすい' },
  { area: '柏原市・高井田・国分', city: '大阪府柏原市',    shift: '8:00〜17:00', vol: '60〜85件',  note: '住宅地が集中しルート効率が良い' },
  { area: '羽曳野市・古市・駒ヶ谷', city: '大阪府羽曳野市', shift: '8:00〜17:00', vol: '65〜90件', note: '一戸建て中心の住宅地で落ち着いて配達できる' },
  ...
  { area: '和泉市・岸和田北',     city: '大阪府和泉市',    shift: '8:00〜17:00', vol: '65〜90件',  note: '新興住宅地が増加中で若いファミリー層が多い' },
  ...
  return [
    {
      ...
      a: 'はい、AT限定で大丈夫です。軽バン・軽箱バンはAT車です。',
    },
    {
      q: '車は自分で用意しないといけませんか？',
    ...
    {
      q: '1日何件くらい配達しますか？',
      a: `${area}エリアは1日60〜90件が目安です。慣れてくると午後3〜4時頃には配達完了できます。`,
    },
    {
      q: '宅配の経験がなくても大丈夫ですか？',
...
async function main() {
  console.log(`\n🚀 軽配送ドライバー求人（月収39万円以上）${JOBS.length}件 の登録を開始します...\n`);
