...
'use strict';
/**
 * AMBITION合同会社（am）／配送・送迎ドライバー正社員求人（求人ボックス掲載）— 大阪バッチ・第6弾25件
 *
 * 2026-09-25、日次の求人ボックス求人作成に伴う追加バッチ。第1〜5弾（1丁目・2丁目表記まで使用済み）
 * と重複しないよう、既使用ベースエリアの3丁目表記（実在の町名がベース）で構成。
 * 内容方針は第1〜5弾と同一。
 *
 * 冪等化: 自分のタイトル（company='am'）のみ削除してから投入。
 *
 * 実行: node --experimental-sqlite scripts/seed-am-osaka-driver-round6-kyujinbox.js
 */
...
// 既存114件（第1〜5弾）と重複しない新規25エリア（既使用ベースの3丁目表記）
const AREAS = [
  { area: '大阪市北区梅田3丁目',       city: '大阪府大阪市北区梅田3丁目',       jobType: '配送ドライバー' },
  { area: '大阪市北区茶屋町3丁目',     city: '大阪府大阪市北区茶屋町3丁目',     jobType: '配送ドライバー' },
  { area: '大阪市北区中崎西3丁目',     city: '大阪府大阪市北区中崎西3丁目',     jobType: '配送ドライバー' },
  { area: '大阪市北区天神橋3丁目',     city: '大阪府大阪市北区天神橋3丁目',     jobType: '配送ドライバー' },
  { area: '大阪市中央区心斎橋3丁目',   city: '大阪府大阪市中央区心斎橋3丁目',   jobType: '配送ドライバー' },
  { area: '大阪市中央区難波3丁目',     city: '大阪府大阪市中央区難波3丁目',     jobType: '配送ドライバー' },
  { area: '大阪市中央区谷町3丁目',     city: '大阪府大阪市中央区谷町3丁目',     jobType: '配送ドライバー' },
  { area: '大阪市中央区本町3丁目',     city: '大阪府大阪市中央区本町3丁目',     jobType: '配送ドライバー' },
  { area: '大阪市西区靭本町3丁目',     city: '大阪府大阪市西区靭本町3丁目',     jobType: '配送ドライバー' },
  { area: '大阪市西区新町3丁目',       city: '大阪府大阪市西区新町3丁目',       jobType: '配送ドライバー' },
  { area: '大阪市西区阿波座3丁目',     city: '大阪府大阪市西区阿波座3丁目',     jobType: '配送ドライバー' },
  { area: '大阪市天王寺区悲田院町3丁目', city: '大阪府大阪市天王寺区悲田院町3丁目', jobType: '配送ドライバー' },
  { area: '大阪市天王寺区上本町3丁目', city: '大阪府大阪市天王寺区上本町3丁目', jobType: '配送ドライバー' },
  { area: '大阪市浪速区難波中3丁目',   city: '大阪府大阪市浪速区難波中3丁目',   jobType: '送迎ドライバー' },
  { area: '大阪市浪速区恵美須西3丁目', city: '大阪府大阪市浪速区恵美須西3丁目', jobType: '送迎ドライバー' },
  { area: '大阪市淀川区西中島3丁目',   city: '大阪府大阪市淀川区西中島3丁目',   jobType: '送迎ドライバー' },
  { area: '大阪市淀川区十三本町3丁目', city: '大阪府大阪市淀川区十三本町3丁目', jobType: '送迎ドライバー' },
  { area: '大阪市東淀川区豊里3丁目',   city: '大阪府大阪市東淀川区豊里3丁目',   jobType: '送迎ドライバー' },
  { area: '大阪市東淀川区瑞光3丁目',   city: '大阪府大阪市東淀川区瑞光3丁目',   jobType: '送迎ドライバー' },
  { area: '大阪市都島区都島本通3丁目', city: '大阪府大阪市都島区都島本通3丁目', jobType: '送迎ドライバー' },
  { area: '大阪市城東区今福西3丁目',   city: '大阪府大阪市城東区今福西3丁目',   jobType: '送迎ドライバー' },
  { area: '大阪市城東区蒲生3丁目',     city: '大阪府大阪市城東区蒲生3丁目',     jobType: '送迎ドライバー' },
  { area: '大阪市鶴見区今津中3丁目',   city: '大阪府大阪市鶴見区今津中3丁目',   jobType: '送迎ドライバー' },
  { area: '大阪市旭区大宮3丁目',       city: '大阪府大阪市旭区大宮3丁目',       jobType: '送迎ドライバー' },
  { area: '大阪市阿倍野区阪南町3丁目', city: '大阪府大阪市阿倍野区阪南町3丁目', jobType: '送迎ドライバー' },
];
...
function buildDescription(a, kind) {
  ...
  const intro = pick(INTRO, a.area, `am6:${kind}:intro`)(a.area);
...
const JOBS = AREAS.map(a => {
  ...
  const title = `【${a.area}】${pick(TITLE_POOL, a.area, `am6:${kind}:title`)}`;
  return {
...
async function main() {
  console.log(`\n🚚 AMBITION 配送・送迎ドライバー求人 第6弾（求人ボックス・大阪）${JOBS.length}件 を登録します...\n`);
