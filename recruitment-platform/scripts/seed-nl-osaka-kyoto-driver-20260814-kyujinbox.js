...
'use strict';
/**
 * 株式会社NOWLIVE（nl）／配送・ルートドライバー 今日のバッチ（2026-08-14・求人ボックス掲載）— 大阪・京都
 ...
 *
 * 実行: node --experimental-sqlite scripts/seed-nl-osaka-kyoto-driver-20260814-kyujinbox.js
 */
...
const AREAS = [
  { area: '大阪市住吉区殿辻1丁目',   city: '大阪府大阪市住吉区殿辻1丁目' },
  { area: '大阪市東住吉区東田辺3丁目',   city: '大阪府大阪市東住吉区東田辺3丁目' },
  { area: '大阪市平野区加美南5丁目',   city: '大阪府大阪市平野区加美南5丁目' },
  { area: '大阪市西成区太子2丁目',   city: '大阪府大阪市西成区太子2丁目' },
  { area: '大阪市港区弁天6丁目',   city: '大阪府大阪市港区弁天6丁目' },
  { area: '大阪市大正区北村1丁目',   city: '大阪府大阪市大正区北村1丁目' },
  { area: '大阪市此花区春日出南3丁目',   city: '大阪府大阪市此花区春日出南3丁目' },
  { area: '大阪市淀川区新高5丁目',   city: '大阪府大阪市淀川区新高5丁目' },
  { area: '大阪市東淀川区豊里6丁目',   city: '大阪府大阪市東淀川区豊里6丁目' },
  { area: '大阪市旭区中宮2丁目',   city: '大阪府大阪市旭区中宮2丁目' },
  { area: '京都市中京区西ノ京南聖町',   city: '京都府京都市中京区西ノ京南聖町' },
  { area: '京都市下京区東塩小路町',   city: '京都府京都市下京区東塩小路町' },
  { area: '京都市南区吉祥院石原町',   city: '京都府京都市南区吉祥院石原町' },
  { area: '京都市右京区嵯峨天龍寺',   city: '京都府京都市右京区嵯峨天龍寺' },
  { area: '京都市左京区聖護院川原町',   city: '京都府京都市左京区聖護院川原町' },
  { area: '京都市東山区三条通',   city: '京都府京都市東山区三条通' },
  { area: '京都市山科区椥辻池尻町',   city: '京都府京都市山科区椥辻池尻町' },
  { area: '京都市伏見区深草稲荷',   city: '京都府京都市伏見区深草稲荷' },
  { area: '京都市北区紫竹西野山',   city: '京都府京都市北区紫竹西野山' },
  { area: '宇治市槇島町一町田',   city: '京都府宇治市槇島町一町田' },
  { area: '城陽市寺田今堀',   city: '京都府城陽市寺田今堀' },
  { area: '長岡京市開田4丁目',   city: '京都府長岡京市開田4丁目' },
  { area: '木津川市州見台2丁目',   city: '京都府木津川市州見台2丁目' },
  { area: '京都市西京区上桂',   city: '京都府京都市西京区上桂' },
  { area: '宇治市大久保町',   city: '京都府宇治市大久保町' },
];
