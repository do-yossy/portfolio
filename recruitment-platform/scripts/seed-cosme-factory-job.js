...
'use strict';
/**
 * コスメ製造スタッフ求人（製造・工場・自社サイト用）登録スクリプト
 *
 * 実行方法（recruitment-platform ディレクトリで）:
 *   node --experimental-sqlite scripts/seed-cosme-factory-job.js
 *
...
const TITLE_PREFIX = 'コスメ製造スタッフ';

const JOB = {
  title: 'コスメ製造スタッフ／＜月給25万円〜32万円＞新事業オープニングメンバー募集・未経験歓迎・完全週休2日制（土日休み）★',
  location: '東京都昭島市',
  salary: '月給250,000円〜320,000円',
  jobType: '製造・工場',
  employmentType: '正社員',
  catchcopy: `新規事業スタートにつきオープニングメンバー募集！
コスメや美容に関わるお仕事、はじめませんか？
...
需要が拡大するコスメ・美容関連商品の製造事業を新たに立ち上げます。

今回募集するのは、事業のスタートを一緒に支えてくれる製造スタッフです。

化粧品や美容関連商品の製造・検品・梱包を担当するお仕事で、製造工程のサポート業務が中心となり、特別な知識や経験は必要ありません。
...
長期`,
  ...
  faq: [
    ...
    },
    {
      ...
      a: '新規事業として立ち上げるコスメ製造事業の第一期メンバーの募集です。全員が同時スタートのため人間関係に馴染みやすく、将来的にはリーダーや管理職へのキャリアアップのチャンスもあります。',
    },
    {
      q: '土日は必ず休めますか？',
