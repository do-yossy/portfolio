...
const JOB = {
  title: 'コスメ製造スタッフ／＜月給25万円〜32万円＞未経験歓迎・完全週休2日制（土日休み）・年間休日123日★',
  location: '東京都昭島市',
  salary: '月給250,000円〜320,000円',
  jobType: '製造・工場',
  employmentType: '正社員',
  catchcopy: `コスメや美容に関わるお仕事、はじめませんか？
月給25万円〜32万円／年収例：入社1年目420万円
未経験歓迎♪マニュアル完備で安心スタート
完全週休2日制（土日休み）・年間休日123日
空調完備の快適な職場環境★`,
  description: `【お仕事内容】
化粧品や美容関連商品の製造・検品・梱包を担当するお仕事です。
...
長期`,
  ...
  faq: [
    {
      q: '未経験でも応募できますか？',
      a: 'はい、大歓迎です。マニュアルに沿って作業を進めるため、特別な知識や経験は必要ありません。入社後は安全教育と作業研修からスタートし、先輩スタッフが丁寧にサポートします。',
    },
    {
      q: '土日は必ず休めますか？',
