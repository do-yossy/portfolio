...
'use strict';
/**
 * 株式会社NOWLIVE（nl）／移動販売車の送迎ドライバー 求人（求人ボックス掲載）— 補充バッチ第2弾（restock2）
 * 会社理念「ワクワクする未来を選ぶ」・食品催事／イベントプロモーション／配送物流に合わせた内容。
 * 大阪の未使用エリア25か所（堺市各区＋北摂・泉州・河内の未使用市）で、内容が重複しないよう
 * エリア名でシードしたバリエーションを付与。
 *
 * ※ 既存バッチと重複させない。
 *    - seed-nl-movingsales-kyujinbox.js:        大阪市中央区/北区/浪速区/西区/淀川区/住之江区、
 *                                               東大阪市、堺市堺区、吹田市、豊中市
 *    - seed-nl-movingsales-restock-kyujinbox.js: 大阪市都島/福島/此花/港/大正/天王寺/西淀川/東淀川/
 *                                               東成/生野/旭/城東/阿倍野/住吉/東住吉/西成/平野/鶴見、
 *                                               高槻市/枚方市/茨木市/八尾市/守口市/門真市/寝屋川市
 *    → 上記2バッチで大阪市24区は全て使用済み。本バッチは堺市の各区（堺区を除く）と
 *      未使用の大阪府内の市を採用。
 *
 * 冪等化: タイトルはエリア名を含むため一意。既存の同一タイトル（＝今回の25件）のみを
 *         上書き更新し、それ以外の他バッチ（元25件を含む）は一切変更しない＝追加。
 *
 * 実行: node --experimental-sqlite scripts/seed-nl-movingsales-restock2-kyujinbox.js
 *
...
// 大阪の掲載エリア（補充第2弾25か所・既存2バッチと重複しない未使用エリア）
const AREAS = [
  // ── 堺市の未使用区（6件・堺区は既存バッチで使用済みのため除外）──
  { area: '堺市中区',   city: '大阪府堺市中区' },
  { area: '堺市東区',   city: '大阪府堺市東区' },
  { area: '堺市西区',   city: '大阪府堺市西区' },
  { area: '堺市南区',   city: '大阪府堺市南区' },
  { area: '堺市北区',   city: '大阪府堺市北区' },
  { area: '堺市美原区', city: '大阪府堺市美原区' },
  // ── 大阪府 未使用市（19件・北摂／泉州／河内）──
  { area: '池田市',     city: '大阪府池田市' },
  { area: '箕面市',     city: '大阪府箕面市' },
  { area: '摂津市',     city: '大阪府摂津市' },
  { area: '岸和田市',   city: '大阪府岸和田市' },
  { area: '泉大津市',   city: '大阪府泉大津市' },
  { area: '貝塚市',     city: '大阪府貝塚市' },
  { area: '和泉市',     city: '大阪府和泉市' },
  { area: '泉佐野市',   city: '大阪府泉佐野市' },
  { area: '富田林市',   city: '大阪府富田林市' },
  { area: '河内長野市', city: '大阪府河内長野市' },
  { area: '松原市',     city: '大阪府松原市' },
  { area: '大東市',     city: '大阪府大東市' },
  { area: '柏原市',     city: '大阪府柏原市' },
  { area: '羽曳野市',   city: '大阪府羽曳野市' },
  { area: '四條畷市',   city: '大阪府四條畷市' },
  { area: '交野市',     city: '大阪府交野市' },
  { area: '高石市',     city: '大阪府高石市' },
  { area: '藤井寺市',   city: '大阪府藤井寺市' },
  { area: '大阪狭山市', city: '大阪府大阪狭山市' },
];
...
async function main() {
  console.log(`\n🚚 NOWLIVE 移動販売車の送迎ドライバー求人（求人ボックス・補充第2弾）${JOBS.length}件 を登録/更新します...\n`);
