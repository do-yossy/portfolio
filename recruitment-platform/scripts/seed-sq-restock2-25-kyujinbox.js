'use strict';
// ルート配送ドライバー（企業配送）求人25件・追加リストック第2弾（求人ボックス掲載）
// 関西の新規エリア（大阪市は飽和のため回避／既存75件バッチと重複しない実在の市区町）で構成。
// 各件ユニークな実在の市区町名。給与は「月給42万円〜62万円」。
// 冪等: 今回の勤務地のみ削除してから作り直す（他バッチ＝既存75件は消さない＝追加）。
// 雛形: seed-sq-weekly-restock-kyujinbox.js の AREASループ＋INSERT構造を踏襲（勤務地エリアのみ差し替え）。
...
// 本バッチ: 関西の新規エリア25件（大阪市以外・各件ユニークな実在の市区町名／既存75件と非重複）。
const AREAS = [
  // 兵庫県（既存75件と重複しない市区町）
  { pref: '兵庫県', city: '明石市',     district: '二見町',   client: '食品・飲料メーカー' },
  { pref: '兵庫県', city: '加古川市',   district: '加古川町', client: '工場・倉庫向け資材' },
  { pref: '兵庫県', city: '宝塚市',     district: '山本',     client: '企業・商業施設向け日用品' },
  { pref: '兵庫県', city: '伊丹市',     district: '中央',     client: '食品・日用品卸売' },
  { pref: '兵庫県', city: '川西市',     district: '栄町',     client: '食品・工業用品メーカー' },
  { pref: '兵庫県', city: '三田市',     district: '三輪',     client: '医療機器・事業所向け用品' },
  { pref: '兵庫県', city: '高砂市',     district: '荒井町',   client: '工場・物流センター向け' },
  { pref: '兵庫県', city: '三木市',     district: '大村',     client: '食品・工業資材メーカー' },
  { pref: '兵庫県', city: '小野市',     district: '王子町',   client: '食品・飲料メーカー' },
  // 京都府（既存75件と重複しない市区町）
  { pref: '京都府', city: '宇治市',     district: '宇治',     client: '工場・倉庫向け資材' },
  { pref: '京都府', city: '長岡京市',   district: '開田',     client: '企業・商業施設向け日用品' },
  { pref: '京都府', city: '亀岡市',     district: '大井町',   client: '食品・日用品卸売' },
  { pref: '京都府', city: '城陽市',     district: '久世',     client: '食品・工業用品メーカー' },
  { pref: '京都府', city: '木津川市',   district: '木津',     client: '医療機器・事業所向け用品' },
  // 奈良県（既存75件と重複しない市区町）
  { pref: '奈良県', city: '橿原市',     district: '曲川町',   client: '工場・物流センター向け' },
  { pref: '奈良県', city: '生駒市',     district: '北新町',   client: '食品・工業資材メーカー' },
  { pref: '奈良県', city: '大和郡山市', district: '筒井町',   client: '食品・飲料メーカー' },
  { pref: '奈良県', city: '桜井市',     district: '桜井',     client: '工場・倉庫向け資材' },
  // 滋賀県（既存75件と重複しない市区町）
  { pref: '滋賀県', city: '大津市',     district: '瀬田',     client: '企業・商業施設向け日用品' },
  { pref: '滋賀県', city: '草津市',     district: '大路',     client: '食品・日用品卸売' },
  { pref: '滋賀県', city: '守山市',     district: '今宿',     client: '食品・工業用品メーカー' },
  { pref: '滋賀県', city: '彦根市',     district: '古沢町',   client: '医療機器・事業所向け用品' },
  // 和歌山県（既存75件と重複しない市区町）
  { pref: '和歌山県', city: '和歌山市', district: '湊',       client: '工場・物流センター向け' },
  { pref: '和歌山県', city: '岩出市',   district: '中黒',     client: '食品・工業資材メーカー' },
  { pref: '和歌山県', city: '海南市',   district: '日方',     client: '食品・飲料メーカー' },
];
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）・追加リストック第2弾・関西新規エリア25件）`);
