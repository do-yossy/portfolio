'use strict';
// SQ（company='sq'）大阪府 今日のバッチ（2026-08-03）：ルート配送ドライバー25件（求人ボックス掲載）
...
const HAISOU_AREAS = [
  { pref: '大阪府', city: '大阪市北区',     district: '中之島3丁目',   client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市中央区',   district: '谷町6丁目',     client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市西区',     district: '北堀江2丁目',   client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市天王寺区', district: '上本町6丁目',   client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市城東区',   district: '中央1丁目',     client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市旭区',     district: '高殿4丁目',     client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市鶴見区',   district: '放出東2丁目',   client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市住吉区',   district: '我孫子3丁目',   client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市東住吉区', district: '駒川5丁目',     client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市平野区',   district: '加美北6丁目',   client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '大阪市都島区',   district: '友渕町2丁目',   client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市淀川区',   district: '十三本町1丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市東成区',   district: '東今里3丁目',   client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '堺市堺区',       district: '大町東1丁',     client: '工場・物流センター向け' },
  { pref: '大阪府', city: '堺市北区',       district: '北花田町2丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '東大阪市',       district: '長堂1丁目',     client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '吹田市',         district: '江の木町',      client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '豊中市',         district: '本町3丁目',     client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '高槻市',         district: '城北町1丁目',   client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '茨木市',         district: '駅前3丁目',     client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '枚方市',         district: '大垣内町2丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '八尾市',         district: '北本町2丁目',   client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '寝屋川市',       district: '早子町',        client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '守口市',         district: '河原町',        client: '工場・物流センター向け' },
  { pref: '大阪府', city: '門真市',         district: '新橋町',        client: '食品・飲料メーカー' },
];
