'use strict';
// SQ（company='sq'）大阪府 今日のバッチ（2026-08-13）：ルート配送ドライバー25件（求人ボックス掲載）
...
const HAISOU_AREAS = [
  { pref: '大阪府', city: '大阪市北区', district: '長柄東2丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市中央区', district: '南本町4丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市西区', district: '川口3丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市天王寺区', district: '勝山3丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市城東区', district: '中浜3丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市旭区', district: '清水4丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市鶴見区', district: '緑2丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市住吉区', district: '帝塚山中3丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市東住吉区', district: '照ケ丘矢田1丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市平野区', district: '長吉出戸5丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市都島区', district: '友渕町3丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市淀川区', district: '加島4丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市東成区', district: '東中本3丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '堺市堺区', district: '向陵中町3丁', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '堺市中区', district: '深阪2丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '東大阪市', district: '高井田元町1丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '吹田市', district: '広芝町2丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '豊中市', district: '庄内幸町3丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '高槻市', district: '大手町', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '茨木市', district: '舟木町', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '枚方市', district: '走谷1丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '八尾市', district: '青山町3丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '寝屋川市', district: '秦町', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '守口市', district: '滝井元町1丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '門真市', district: '常盤町', client: '食品・日用品卸売' },
];
