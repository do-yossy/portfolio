'use strict';
// ST（company='st' 有限会社Style501）大阪府 今日のバッチ（2026-08-31）：配送ドライバー10件＋送迎ドライバー15件＝25件（求人ボックス掲載）
...
const AREAS_HAISOU = [
  { pref: '大阪府', city: '大阪市', district: '西淀川区姫島3丁目' },
  { pref: '大阪府', city: '大阪市', district: '住之江区平林北2丁目' },
  { pref: '大阪府', city: '大阪市', district: '大正区南恩加島3丁目' },
  { pref: '大阪府', city: '大阪市', district: '西成区聖天下2丁目' },
  { pref: '大阪府', city: '大阪市', district: '港区弁天2丁目' },
  { pref: '大阪府', city: '大阪市', district: '此花区伝法2丁目' },
  { pref: '大阪府', city: '大阪市', district: '東成区深江北2丁目' },
  { pref: '大阪府', city: '大阪市', district: '城東区野江2丁目' },
  { pref: '大阪府', city: '大阪市', district: '鶴見区諸口4丁目' },
  { pref: '大阪府', city: '大阪市', district: '生野区田島4丁目' },
];
...
const AREAS_SOUTEI = [
  { pref: '大阪府', city: '堺市', district: '堺区大町西2丁' },
  { pref: '大阪府', city: '堺市', district: '中区東山' },
  { pref: '大阪府', city: '堺市', district: '東区日置荘西町2丁' },
  { pref: '大阪府', city: '堺市', district: '西区浜寺元町4丁' },
  { pref: '大阪府', city: '堺市', district: '南区茶山台4丁' },
  { pref: '大阪府', city: '堺市', district: '北区新金岡町5丁' },
  { pref: '大阪府', city: '堺市', district: '美原区北余部' },
  { pref: '大阪府', city: '和泉市', district: '幸2丁目' },
  { pref: '大阪府', city: '岸和田市', district: '上町' },
  { pref: '大阪府', city: '泉大津市', district: '助松町' },
  { pref: '大阪府', city: '貝塚市', district: '堀' },
  { pref: '大阪府', city: '泉佐野市', district: '湊1丁目' },
  { pref: '大阪府', city: '松原市', district: '天美北5丁目' },
  { pref: '大阪府', city: '大東市', district: '氷野2丁目' },
