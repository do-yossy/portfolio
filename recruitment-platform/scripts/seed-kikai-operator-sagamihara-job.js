...
'use strict';
/**
 * 機械オペレーター求人（製造・工場・自社サイト用）登録スクリプト
 * 神奈川県相模原市
 *
 * 実行方法（recruitment-platform ディレクトリで）:
 *   node --experimental-sqlite scripts/seed-kikai-operator-sagamihara-job.js
 *
...
const TITLE_PREFIX = '機械オペレーター（相模原）';
...
今回募集するのは、事業のスタートを一緒に支えてくれる機械オペレーターです。

製造機械の操作・監視・簡単なメンテナンスを担当するお仕事で、機械の操作が中心となります。特別な知識や経験は必要ありません。
