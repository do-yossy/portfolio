...
const JOB = {
  ...
  jobType: 'IT',
  employmentType: '正社員',
  catchcopy: `クリエイティブ制作を支える進行管理のプロへ！
月給24.2万円〜28万円／想定年収360万円〜420万円
ディレクション経験不問・進行管理が得意な方歓迎
完全週休2日制（土日）・年間休日127日
転勤なし・服装自由・時差出勤制度あり`,
  description: `【お仕事内容】
クリエイティブ部門と連携しながら、ダイレクトメール（DM）制作の案件進行管理・ディレクションをメインにお任せします。
...
■この仕事の魅力
◎組織の課題解決に直結するやりがい
案件数が増加傾向にあり、今後の成長を見据えた体制強化が急務となっています。あなたのディレクション力でチームの推進力を高め、制作体制の強化に直接貢献できる非常に重要なポジションです。

◎実践の中で広がる裁量
まずは決まった手順での進行管理からスタートし、慣れてきたらイレギュラー対応や判断・調整もお任せしていきます。将来的にはデザインの品質面にも関わるディレクションへと、実務を通じてステップアップしていける環境です。

◎幅広いビジネス視点が身につく
クライアント視点とクリエイティブ視点の両方を持ち合わせることで、調整力やプロジェクトマネジメントスキルが飛躍的に向上します。
...
長期`,
  ...
  faq: [
    ...
    {
      q: '必須の応募条件はありますか？',
      a: '社会人経験（目安1〜2年以上）、社内外との折衝経験（カスタマーサクセス・企画・制作進行など）、基本的なPCスキルが必須要件です。',
    },
    {
      q: 'デザインスキルは必要ですか？',
