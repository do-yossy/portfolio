'use strict';
// ST（company='st' 有限会社Style501）大阪府 今日のバッチ（2026-08-09）：配送ドライバー10件＋送迎ドライバー15件＝25件（求人ボックス掲載）
...
const AREAS_HAISOU = [
  { pref: '大阪府', city: '大阪市', district: '西淀川区御幣島3丁目' },
  { pref: '大阪府', city: '大阪市', district: '住之江区中加賀屋2丁目' },
  { pref: '大阪府', city: '大阪市', district: '大正区北村3丁目' },
  { pref: '大阪府', city: '大阪市', district: '西成区岸里東1丁目' },
  { pref: '大阪府', city: '大阪市', district: '港区築港1丁目' },
  { pref: '大阪府', city: '大阪市', district: '此花区四貫島1丁目' },
  { pref: '大阪府', city: '大阪市', district: '東成区深江南2丁目' },
  { pref: '大阪府', city: '大阪市', district: '城東区今福東2丁目' },
  { pref: '大阪府', city: '大阪市', district: '鶴見区諸口2丁目' },
  { pref: '大阪府', city: '大阪市', district: '生野区勝山南3丁目' },
];
...
const AREAS_SOUTEI = [
  { pref: '大阪府', city: '堺市', district: '堺区大町東2丁' },
  { pref: '大阪府', city: '堺市', district: '中区平井' },
  { pref: '大阪府', city: '堺市', district: '東区丈六' },
  { pref: '大阪府', city: '堺市', district: '西区津久野町3丁' },
  { pref: '大阪府', city: '堺市', district: '南区槇塚台3丁' },
  { pref: '大阪府', city: '堺市', district: '北区野遠町' },
  { pref: '大阪府', city: '堺市', district: '美原区今井' },
  { pref: '大阪府', city: '和泉市', district: '池田下町' },
  { pref: '大阪府', city: '岸和田市', district: '別所町2丁目' },
  { pref: '大阪府', city: '泉大津市', district: '我孫子' },
  { pref: '大阪府', city: '貝塚市', district: '王子' },
  { pref: '大阪府', city: '泉佐野市', district: '長滝' },
  { pref: '大阪府', city: '松原市', district: '別所8丁目' },
  { pref: '大阪府', city: '大東市', district: '諸福7丁目' },
  { pref: '大阪府', city: '河内長野市', district: '昭栄町' },
];
