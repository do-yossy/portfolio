...
'use strict';
/**
 * 株式会社NOWLIVE（nl）／配送・ルートドライバー 今日のバッチ（2026-08-06・求人ボックス掲載）— 大阪・京都
 ...
 *
 * 実行: node --experimental-sqlite scripts/seed-nl-osaka-kyoto-driver-20260806-kyujinbox.js
 */
...
const AREAS = [
  { area: '大阪市住之江区新北島2丁目',   city: '大阪府大阪市住之江区新北島2丁目' },
  { area: '大阪市西成区橘3丁目',   city: '大阪府大阪市西成区橘3丁目' },
  { area: '大阪市港区築港2丁目',   city: '大阪府大阪市港区築港2丁目' },
  { area: '大阪市大正区鶴町3丁目',   city: '大阪府大阪市大正区鶴町3丁目' },
  { area: '大阪市此花区四貫島2丁目',   city: '大阪府大阪市此花区四貫島2丁目' },
  { area: '大阪市東成区玉津3丁目',   city: '大阪府大阪市東成区玉津3丁目' },
  { area: '大阪市生野区林寺5丁目',   city: '大阪府大阪市生野区林寺5丁目' },
  { area: '大阪市旭区太子橋2丁目',   city: '大阪府大阪市旭区太子橋2丁目' },
  { area: '大阪市鶴見区今津中3丁目',   city: '大阪府大阪市鶴見区今津中3丁目' },
  { area: '大阪市城東区中央2丁目',   city: '大阪府大阪市城東区中央2丁目' },
  { area: '京都市中京区壬生',   city: '京都府京都市中京区壬生' },
  { area: '京都市下京区七条御所ノ内',   city: '京都府京都市下京区七条御所ノ内' },
  { area: '京都市南区東九条',   city: '京都府京都市南区東九条' },
  { area: '京都市右京区西院',   city: '京都府京都市右京区西院' },
  { area: '京都市左京区高野',   city: '京都府京都市左京区高野' },
  { area: '京都市東山区五条',   city: '京都府京都市東山区五条' },
  { area: '京都市山科区勧修寺',   city: '京都府京都市山科区勧修寺' },
  { area: '京都市伏見区醍醐',   city: '京都府京都市伏見区醍醐' },
  { area: '京都市北区衣笠',   city: '京都府京都市北区衣笠' },
  { area: '宇治市大久保',   city: '京都府宇治市大久保' },
  { area: '亀岡市篠町',   city: '京都府亀岡市篠町' },
  { area: '城陽市久世',   city: '京都府城陽市久世' },
  { area: '向日市森本町',   city: '京都府向日市森本町' },
  { area: '長岡京市開田',   city: '京都府長岡京市開田' },
  { area: '木津川市州見台',   city: '京都府木津川市州見台' },
];
