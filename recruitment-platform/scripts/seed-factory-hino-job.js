 ...
 *   node --experimental-sqlite scripts/seed-factory-hino-job.js
 *
...
const TITLE_PREFIX = '製造スタッフ（日野）';

const JOB = {
  title: '製造スタッフ（日野）／＜月給25万円〜32万円＞新事業オープニングメンバー募集・未経験歓迎・完全週休2日制（土日休み）★',
  location: '東京都日野市（日野駅徒歩圏内）',
