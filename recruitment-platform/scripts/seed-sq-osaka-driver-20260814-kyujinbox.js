'use strict';
// SQ（company='sq'）大阪府 今日のバッチ（2026-08-14）：ルート配送ドライバー25件（求人ボックス掲載）
...
const HAISOU_AREAS = [
  { pref: '大阪府', city: '大阪市北区', district: '浮田1丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市中央区', district: '安堂寺町2丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市西区', district: '南堀江4丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市天王寺区', district: '味原本町', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市旭区', district: '清水3丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市鶴見区', district: '横堤4丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市住吉区', district: '帝塚山西4丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市東住吉区', district: '鷹合3丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市平野区', district: '喜連西5丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市都島区', district: '中野町1丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市淀川区', district: '木川東2丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市東成区', district: '大今里西3丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市生野区', district: '巽中3丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市西成区', district: '岸里東3丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市港区', district: '市岡3丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市此花区', district: '高見2丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市福島区', district: '鷺洲2丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市大正区', district: '泉尾2丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市浪速区', district: '恵美須西3丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市北区', district: '神山町', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市中央区', district: '高津3丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市阿倍野区', district: '昭和町4丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市東淀川区', district: '東中島5丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市城東区', district: '中央4丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市西成区', district: '天下茶屋東2丁目', client: '食品・日用品卸売' },
];
