'use strict';
// ST（company='st' 有限会社Style501）大阪府 今日のバッチ（2026-08-12）：配送ドライバー10件＋送迎ドライバー15件＝25件（求人ボックス掲載）
...
const AREAS_HAISOU = [
  { pref: '大阪府', city: '大阪市', district: '西淀川区柏里2丁目' },
  { pref: '大阪府', city: '大阪市', district: '住之江区安立4丁目' },
  { pref: '大阪府', city: '大阪市', district: '大正区泉尾7丁目' },
  { pref: '大阪府', city: '大阪市', district: '西成区玉出西3丁目' },
  { pref: '大阪府', city: '大阪市', district: '港区弁天3丁目' },
  { pref: '大阪府', city: '大阪市', district: '此花区四貫島3丁目' },
  { pref: '大阪府', city: '大阪市', district: '東成区中本2丁目' },
  { pref: '大阪府', city: '大阪市', district: '城東区鴫野西2丁目' },
  { pref: '大阪府', city: '大阪市', district: '鶴見区今津南2丁目' },
  { pref: '大阪府', city: '大阪市', district: '生野区田島3丁目' },
];
...
const AREAS_SOUTEI = [
  { pref: '大阪府', city: '堺市', district: '堺区北旅籠町東2丁' },
  { pref: '大阪府', city: '堺市', district: '中区毛穴町' },
  { pref: '大阪府', city: '堺市', district: '東区大美野' },
  { pref: '大阪府', city: '堺市', district: '西区浜寺元町3丁' },
  { pref: '大阪府', city: '堺市', district: '南区茶山台1丁' },
  { pref: '大阪府', city: '堺市', district: '北区百舌鳥梅町2丁' },
  { pref: '大阪府', city: '堺市', district: '美原区平尾' },
  { pref: '大阪府', city: '和泉市', district: '伯太町3丁目' },
  { pref: '大阪府', city: '岸和田市', district: '下松町4丁目' },
  { pref: '大阪府', city: '泉大津市', district: '池浦町2丁目' },
  { pref: '大阪府', city: '貝塚市', district: '堀3丁目' },
  { pref: '大阪府', city: '泉佐野市', district: '高松南' },
  { pref: '大阪府', city: '松原市', district: '田井城2丁目' },
  { pref: '大阪府', city: '大東市', district: '寺川3丁目' },
  { pref: '大阪府', city: '河内長野市', district: '古野町' },
];
