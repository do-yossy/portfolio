...
'use strict';
/**
 * 株式会社NOWLIVE（nl）／配送・ルートドライバー 今日のバッチ（2026-08-12・求人ボックス掲載）— 大阪・京都
 ...
 *
 * 実行: node --experimental-sqlite scripts/seed-nl-osaka-kyoto-driver-20260812-kyujinbox.js
 */
...
const AREAS = [
  { area: '大阪市住之江区中加賀屋4丁目',   city: '大阪府大阪市住之江区中加賀屋4丁目' },
  { area: '大阪市東成区東小橋2丁目',   city: '大阪府大阪市東成区東小橋2丁目' },
  { area: '大阪市旭区中宮4丁目',   city: '大阪府大阪市旭区中宮4丁目' },
  { area: '大阪市城東区蒲生2丁目',   city: '大阪府大阪市城東区蒲生2丁目' },
  { area: '大阪市西成区梅南2丁目',   city: '大阪府大阪市西成区梅南2丁目' },
  { area: '大阪市港区波除5丁目',   city: '大阪府大阪市港区波除5丁目' },
  { area: '大阪市大正区平尾5丁目',   city: '大阪府大阪市大正区平尾5丁目' },
  { area: '大阪市此花区春日出中1丁目',   city: '大阪府大阪市此花区春日出中1丁目' },
  { area: '大阪市淀川区三国本町3丁目',   city: '大阪府大阪市淀川区三国本町3丁目' },
  { area: '大阪市東淀川区瑞光5丁目',   city: '大阪府大阪市東淀川区瑞光5丁目' },
  { area: '京都市中京区三条',   city: '京都府京都市中京区三条' },
  { area: '京都市下京区花屋町',   city: '京都府京都市下京区花屋町' },
  { area: '京都市南区唐橋',   city: '京都府京都市南区唐橋' },
  { area: '京都市右京区梅津',   city: '京都府京都市右京区梅津' },
  { area: '京都市左京区田中',   city: '京都府京都市左京区田中' },
  { area: '京都市東山区清水',   city: '京都府京都市東山区清水' },
  { area: '京都市山科区東野',   city: '京都府京都市山科区東野' },
  { area: '京都市伏見区中書島',   city: '京都府京都市伏見区中書島' },
  { area: '京都市北区紫竹',   city: '京都府京都市北区紫竹' },
  { area: '宇治市槇島町',   city: '京都府宇治市槇島町' },
  { area: '亀岡市馬路町',   city: '京都府亀岡市馬路町' },
  { area: '城陽市長池',   city: '京都府城陽市長池' },
  { area: '向日市物集女町',   city: '京都府向日市物集女町' },
  { area: '長岡京市今里',   city: '京都府長岡京市今里' },
  { area: '木津川市山城町',   city: '京都府木津川市山城町' },
];
