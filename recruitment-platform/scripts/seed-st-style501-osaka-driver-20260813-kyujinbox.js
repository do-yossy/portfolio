'use strict';
// ST（company='st' 有限会社Style501）大阪府 今日のバッチ（2026-08-13）：配送ドライバー10件＋送迎ドライバー15件＝25件（求人ボックス掲載）
...
const AREAS_HAISOU = [
  { pref: '大阪府', city: '大阪市', district: '此花区梅香1丁目' },
  { pref: '大阪府', city: '大阪市', district: '西淀川区野里2丁目' },
  { pref: '大阪府', city: '大阪市', district: '住之江区浜口西1丁目' },
  { pref: '大阪府', city: '大阪市', district: '大正区北恩加島2丁目' },
  { pref: '大阪府', city: '大阪市', district: '港区弁天5丁目' },
  { pref: '大阪府', city: '大阪市', district: '東成区中道3丁目' },
  { pref: '大阪府', city: '大阪市', district: '城東区永田1丁目' },
  { pref: '大阪府', city: '大阪市', district: '鶴見区安田2丁目' },
  { pref: '大阪府', city: '大阪市', district: '生野区小路東3丁目' },
  { pref: '大阪府', city: '大阪市', district: '旭区中宮2丁目' },
];
...
const AREAS_SOUTEI = [
  { pref: '大阪府', city: '堺市', district: '堺区宿院町東2丁' },
  { pref: '大阪府', city: '堺市', district: '中区福田' },
  { pref: '大阪府', city: '堺市', district: '東区南野田' },
  { pref: '大阪府', city: '堺市', district: '西区浜寺船尾町東3丁' },
  { pref: '大阪府', city: '堺市', district: '南区茶山台3丁' },
  { pref: '大阪府', city: '堺市', district: '北区常磐町2丁' },
  { pref: '大阪府', city: '堺市', district: '美原区太井' },
  { pref: '大阪府', city: '和泉市', district: '唐国町' },
  { pref: '大阪府', city: '岸和田市', district: '磯上町3丁目' },
  { pref: '大阪府', city: '泉大津市', district: '池浦町3丁目' },
  { pref: '大阪府', city: '貝塚市', district: '麻生中' },
  { pref: '大阪府', city: '泉佐野市', district: '日根野' },
  { pref: '大阪府', city: '松原市', district: '一津屋2丁目' },
  { pref: '大阪府', city: '大東市', district: '御領3丁目' },
  { pref: '大阪府', city: '河内長野市', district: '高向' },
];
