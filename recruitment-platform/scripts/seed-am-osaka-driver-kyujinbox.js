...
'use strict';
/**
 * AMBITION合同会社（am）／配送・送迎ドライバー正社員求人（求人ボックス掲載）— 大阪バッチ・初回14件
 *
...
const AREAS = [
  ...
  { area: '大阪市生野区中川', city: '大阪府大阪市生野区中川', jobType: '配送ドライバー' },
  { area: '松原市阿保', city: '大阪府松原市阿保', jobType: '配送ドライバー' },
  { area: '藤井寺市岡', city: '大阪府藤井寺市岡', jobType: '配送ドライバー' },
  ...
  { area: '守口市金田町', city: '大阪府守口市金田町', jobType: '送迎ドライバー' },
  { area: '門真市速見町', city: '大阪府門真市速見町', jobType: '送迎ドライバー' },
  { area: '寝屋川市早子町', city: '大阪府寝屋川市早子町', jobType: '送迎ドライバー' },
];
