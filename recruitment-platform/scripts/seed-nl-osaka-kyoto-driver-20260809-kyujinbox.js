...
'use strict';
/**
 * 株式会社NOWLIVE（nl）／配送・ルートドライバー 今日のバッチ（2026-08-09・求人ボックス掲載）— 大阪・京都
 ...
 *
 * 実行: node --experimental-sqlite scripts/seed-nl-osaka-kyoto-driver-20260809-kyujinbox.js
 */
...
const AREAS = [
  { area: '大阪市住吉区沢之町2丁目',   city: '大阪府大阪市住吉区沢之町2丁目' },
  { area: '大阪市東住吉区針中野2丁目',   city: '大阪府大阪市東住吉区針中野2丁目' },
  { area: '大阪市平野区加美東4丁目',   city: '大阪府大阪市平野区加美東4丁目' },
  { area: '大阪市西成区玉出中1丁目',   city: '大阪府大阪市西成区玉出中1丁目' },
  { area: '大阪市港区三先2丁目',   city: '大阪府大阪市港区三先2丁目' },
  { area: '大阪市大正区泉尾6丁目',   city: '大阪府大阪市大正区泉尾6丁目' },
  { area: '大阪市此花区春日出北3丁目',   city: '大阪府大阪市此花区春日出北3丁目' },
  { area: '大阪市淀川区十三本町3丁目',   city: '大阪府大阪市淀川区十三本町3丁目' },
  { area: '大阪市東淀川区淡路5丁目',   city: '大阪府大阪市東淀川区淡路5丁目' },
  { area: '大阪市旭区生江2丁目',   city: '大阪府大阪市旭区生江2丁目' },
  { area: '京都市中京区二条',   city: '京都府京都市中京区二条' },
  { area: '京都市下京区西七条',   city: '京都府京都市下京区西七条' },
  { area: '京都市南区久世',   city: '京都府京都市南区久世' },
  { area: '京都市右京区花園',   city: '京都府京都市右京区花園' },
  { area: '京都市左京区北白川',   city: '京都府京都市左京区北白川' },
  { area: '京都市東山区本町',   city: '京都府京都市東山区本町' },
  { area: '京都市山科区大宅',   city: '京都府京都市山科区大宅' },
  { area: '京都市伏見区向島',   city: '京都府京都市伏見区向島' },
  { area: '京都市北区大将軍',   city: '京都府京都市北区大将軍' },
  { area: '宇治市小倉町',   city: '京都府宇治市小倉町' },
  { area: '亀岡市千代川町',   city: '京都府亀岡市千代川町' },
  { area: '城陽市富野',   city: '京都府城陽市富野' },
  { area: '向日市上植野町',   city: '京都府向日市上植野町' },
  { area: '長岡京市神足',   city: '京都府長岡京市神足' },
  { area: '木津川市相楽',   city: '京都府木津川市相楽' },
];
