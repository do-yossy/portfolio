'use strict';
// ST（company='st' 有限会社Style501）大阪府 今日のバッチ（2026-08-14）：配送ドライバー10件＋送迎ドライバー15件＝25件（求人ボックス掲載）
...
const AREAS_HAISOU = [
  { pref: '大阪府', city: '大阪市', district: '西淀川区姫里3丁目' },
  { pref: '大阪府', city: '大阪市', district: '住之江区新北島4丁目' },
  { pref: '大阪府', city: '大阪市', district: '大正区泉尾5丁目' },
  { pref: '大阪府', city: '大阪市', district: '西成区玉出中3丁目' },
  { pref: '大阪府', city: '大阪市', district: '此花区春日出北3丁目' },
  { pref: '大阪府', city: '大阪市', district: '東成区東中本1丁目' },
  { pref: '大阪府', city: '大阪市', district: '城東区野江4丁目' },
  { pref: '大阪府', city: '大阪市', district: '鶴見区諸口5丁目' },
  { pref: '大阪府', city: '大阪市', district: '生野区田島2丁目' },
  { pref: '大阪府', city: '大阪市', district: '旭区高殿3丁目' },
];
...
const AREAS_SOUTEI = [
  { pref: '大阪府', city: '堺市', district: '堺区宿院町西2丁' },
  { pref: '大阪府', city: '堺市', district: '中区深井中町' },
  { pref: '大阪府', city: '堺市', district: '東区日置荘原寺町' },
  { pref: '大阪府', city: '堺市', district: '西区浜寺公園町2丁' },
  { pref: '大阪府', city: '堺市', district: '北区北花田町3丁' },
  { pref: '大阪府', city: '堺市', district: '美原区木材通4丁' },
  { pref: '大阪府', city: '泉佐野市', district: '鶴原2丁目' },
  { pref: '大阪府', city: '松原市', district: '阿保6丁目' },
  { pref: '大阪府', city: '大東市', district: '赤井1丁目' },
  { pref: '大阪府', city: '堺市', district: '堺区少林寺町西2丁' },
  { pref: '大阪府', city: '堺市', district: '中区八田北町' },
  { pref: '大阪府', city: '堺市', district: '西区草部' },
  { pref: '大阪府', city: '堺市', district: '南区若松台3丁' },
  { pref: '大阪府', city: '堺市', district: '北区東雲東町2丁' },
  { pref: '大阪府', city: '和泉市', district: '伯太町4丁目' },
];
