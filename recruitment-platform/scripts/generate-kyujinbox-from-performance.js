...
async function main() {
  ...
  // 倉庫・軽作業カテゴリ（有効応募率80〜95%台と全カテゴリ中もっとも好調）で効いている
  // 「かんたん・未経験でも安心・シフト柔軟」という具体的な安心材料の前出しを、他カテゴリにも横展開する。
  const OPEN_LINE = {
    driver: [
    ...
    warehouse: [
      a => `${a}の倉庫・作業場でのかんたんな軽作業です。未経験の方でもすぐに覚えられます。`,
      a => `${a}エリアの拠点で、もくもく作業が中心の軽作業をお任せします。シフト応相談です。`,
      a => `${a}周辺の倉庫内での作業です。マニュアルがあるので未経験でも安心してスタートできます。`,
    ],
    mfg: [
      a => `${a}の拠点での製造・品質管理のお仕事です。手順が決まっているので未経験でも安心です。`,
      a => `${a}エリアの工場で、マニュアルに沿った作業からスタートできます。`,
    ],
    technician: [
      a => `${a}の拠点での設備点検・かんたんな保守作業です。手順に沿って段階的に覚えられます。`,
      a => `${a}エリアで、未経験からでも資格取得支援を受けながらスタートできます。`,
    ],
    sales: [
      a => `${a}エリアの既存のお客様中心・ノルマに追われない提案営業です。`,
      a => `${a}を中心に、飛び込み営業のない既存顧客フォロー中心のお仕事です。`,
    ],
    office: [
      a => `${a}の拠点での事務・サポート業務です。基本的なPC操作ができればOKです。`,
      a => `${a}エリアで、電話・来客対応の少ないコツコツ系の事務のお仕事です。`,
    ],
    event: [
      a => `${a}を中心に、イベント・展示会の現場運営をお任せします。未経験歓迎です。`,
      a => `${a}エリアでの単発・短期ではない、安定して働けるイベント関連のお仕事です。`,
    ],
  };
