...
'use strict';
/**
 * 株式会社NOWLIVE（nl）／配送・ルートドライバー 今日のバッチ（2026-08-10・求人ボックス掲載）— 大阪・京都
 ...
 *
 * 実行: node --experimental-sqlite scripts/seed-nl-osaka-kyoto-driver-20260810-kyujinbox.js
 */
...
const AREAS = [
  { area: '大阪市生野区田島4丁目',   city: '大阪府大阪市生野区田島4丁目' },
  { area: '大阪市東成区中本3丁目',   city: '大阪府大阪市東成区中本3丁目' },
  { area: '大阪市旭区森小路1丁目',   city: '大阪府大阪市旭区森小路1丁目' },
  { area: '大阪市城東区永田2丁目',   city: '大阪府大阪市城東区永田2丁目' },
  { area: '大阪市西成区聖天下1丁目',   city: '大阪府大阪市西成区聖天下1丁目' },
  { area: '大阪市港区市岡元町2丁目',   city: '大阪府大阪市港区市岡元町2丁目' },
  { area: '大阪市大正区平尾4丁目',   city: '大阪府大阪市大正区平尾4丁目' },
  { area: '大阪市此花区梅香2丁目',   city: '大阪府大阪市此花区梅香2丁目' },
  { area: '大阪市淀川区加島2丁目',   city: '大阪府大阪市淀川区加島2丁目' },
  { area: '大阪市東淀川区瑞光3丁目',   city: '大阪府大阪市東淀川区瑞光3丁目' },
  { area: '京都市中京区河原町',   city: '京都府京都市中京区河原町' },
  { area: '京都市下京区大宮',   city: '京都府京都市下京区大宮' },
  { area: '京都市南区西九条',   city: '京都府京都市南区西九条' },
  { area: '京都市右京区常盤',   city: '京都府京都市右京区常盤' },
  { area: '京都市左京区下鴨',   city: '京都府京都市左京区下鴨' },
  { area: '京都市東山区祇園町',   city: '京都府京都市東山区祇園町' },
  { area: '京都市山科区御陵',   city: '京都府京都市山科区御陵' },
  { area: '京都市伏見区竹田',   city: '京都府京都市伏見区竹田' },
  { area: '京都市北区小山',   city: '京都府京都市北区小山' },
  { area: '宇治市五ヶ庄',   city: '京都府宇治市五ヶ庄' },
  { area: '亀岡市余部町',   city: '京都府亀岡市余部町' },
  { area: '城陽市枇杷庄',   city: '京都府城陽市枇杷庄' },
  { area: '向日市鶏冠井町',   city: '京都府向日市鶏冠井町' },
  { area: '長岡京市滝ノ町',   city: '京都府長岡京市滝ノ町' },
  { area: '木津川市加茂町',   city: '京都府木津川市加茂町' },
];
