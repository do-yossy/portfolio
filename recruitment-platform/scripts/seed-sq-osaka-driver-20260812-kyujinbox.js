'use strict';
// SQ（company='sq'）大阪府 今日のバッチ（2026-08-12）：ルート配送ドライバー25件（求人ボックス掲載）
...
const HAISOU_AREAS = [
  { pref: '大阪府', city: '大阪市北区', district: '中津2丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市中央区', district: '安堂寺町1丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市西区', district: '川口2丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市天王寺区', district: '大道2丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市城東区', district: '諏訪1丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市旭区', district: '高殿7丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市鶴見区', district: '安田1丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市住吉区', district: '遠里小野5丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市東住吉区', district: '鷹合2丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市平野区', district: '加美東5丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市都島区', district: '高倉町1丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市淀川区', district: '宮原4丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市東成区', district: '東小橋3丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '堺市堺区', district: '甲斐町東2丁', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '堺市中区', district: '堀上町', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '東大阪市', district: '長田中3丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '吹田市', district: '片山町4丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '豊中市', district: '服部西町2丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '高槻市', district: '宮野町', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '茨木市', district: '総持寺1丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '枚方市', district: '長尾元町3丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '八尾市', district: '老原4丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '寝屋川市', district: '萱島本町', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '守口市', district: '寺方本通2丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '門真市', district: '舟田町', client: '食品・日用品卸売' },
];
