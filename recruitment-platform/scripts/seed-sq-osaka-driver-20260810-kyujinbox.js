'use strict';
// SQ（company='sq'）大阪府 今日のバッチ（2026-08-10）：ルート配送ドライバー25件（求人ボックス掲載）
...
const HAISOU_AREAS = [
  { pref: '大阪府', city: '大阪市北区', district: '大淀南1丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市中央区', district: '島町2丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市西区', district: '靱本町1丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市天王寺区', district: '堂ヶ芝2丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市城東区', district: '鴫野東3丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市旭区', district: '千林2丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市鶴見区', district: '焼野1丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市住吉区', district: '万代3丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市東住吉区', district: '山坂4丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市平野区', district: '背戸口3丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市都島区', district: '毛馬町3丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市淀川区', district: '野中北2丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市東成区', district: '大今里南4丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '堺市堺区', district: '南半町東2丁', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '堺市中区', district: '福田', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '東大阪市', district: '中新開2丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '吹田市', district: '千里山東3丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '豊中市', district: '曽根東町4丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '高槻市', district: '天神町2丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '茨木市', district: '別院町', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '枚方市', district: '香里ケ丘6丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '八尾市', district: '山本町北3丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '寝屋川市', district: '香里本通町', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '守口市', district: '藤田町5丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '門真市', district: '岸和田3丁目', client: '食品・日用品卸売' },
];
