 ...
 *   node --experimental-sqlite scripts/seed-factory-fuchu-job.js
 *
...
const TITLE_PREFIX = '製造スタッフ（府中）';

const JOB = {
  title: '製造スタッフ（府中）／＜月給25万円〜32万円＞新事業オープニングメンバー募集・未経験歓迎・完全週休2日制（土日休み）★',
  location: '東京都府中市（府中駅徒歩圏内）',
