'use strict';
// コスメ配送ドライバー 追加求人25件（Bigeyes・求人ボックス掲載／大阪府ドライバー系）
...
// ※勤務地は大阪府の新エリア25件（実在の市区町名・丁目まで入れて一意）で構成。
//   既存BG seed（seed-bg-weekly-restock-kyujinbox.js の関西75件／
//   seed-bg-restock2-25-kyujinbox.js の関西25件）と重複しない。
//   従来BGは大阪市を避けていたため大阪市各区はすべて新規に使用可能。
//   既存の大阪府エリア（堺市北区中百舌鳥町・豊中市蛍池・吹田市江坂町）は使用しない。
...
// 大阪府の新エリア25件（実在の市区町名・丁目までで一意に構成）
// ※従来BGが避けていた大阪市各区を中心に、既存BGエリアと重複しない市区を追加
const AREAS = [
  // ── 大阪市（17件・全区新規）──
  { pref: '大阪府', city: '大阪市',   district: '北区梅田1丁目' },
  { pref: '大阪府', city: '大阪市',   district: '北区天神橋2丁目' },
  { pref: '大阪府', city: '大阪市',   district: '福島区福島3丁目' },
  { pref: '大阪府', city: '大阪市',   district: '此花区西九条1丁目' },
  { pref: '大阪府', city: '大阪市',   district: '中央区本町2丁目' },
  { pref: '大阪府', city: '大阪市',   district: '中央区難波3丁目' },
  { pref: '大阪府', city: '大阪市',   district: '西区新町1丁目' },
  { pref: '大阪府', city: '大阪市',   district: '港区弁天1丁目' },
  { pref: '大阪府', city: '大阪市',   district: '浪速区元町2丁目' },
  { pref: '大阪府', city: '大阪市',   district: '淀川区西中島5丁目' },
  { pref: '大阪府', city: '大阪市',   district: '東淀川区東中島1丁目' },
  { pref: '大阪府', city: '大阪市',   district: '東成区大今里3丁目' },
  { pref: '大阪府', city: '大阪市',   district: '生野区巽中2丁目' },
  { pref: '大阪府', city: '大阪市',   district: '城東区蒲生4丁目' },
  { pref: '大阪府', city: '大阪市',   district: '阿倍野区阿倍野筋1丁目' },
  { pref: '大阪府', city: '大阪市',   district: '住吉区長居2丁目' },
  { pref: '大阪府', city: '大阪市',   district: '平野区平野本町3丁目' },
  // ── 堺市（2件・既存の北区中百舌鳥町とは別区・別町）──
  { pref: '大阪府', city: '堺市',     district: '堺区市之町東1丁' },
  { pref: '大阪府', city: '堺市',     district: '中区深井沢町' },
  // ── 東大阪市（2件）──
  { pref: '大阪府', city: '東大阪市', district: '長田中2丁目' },
  { pref: '大阪府', city: '東大阪市', district: '荒本北1丁目' },
  // ── 北摂・北河内・中河内（4件・既存の蛍池／江坂町とは別町）──
  { pref: '大阪府', city: '豊中市',   district: '岡町北1丁目' },
  { pref: '大阪府', city: '吹田市',   district: '片山町1丁目' },
  { pref: '大阪府', city: '枚方市',   district: '岡東町' },
  { pref: '大阪府', city: '八尾市',   district: '光町2丁目' },
];
...
console.log(`\n完了: ${created}件作成（Bigeyes・コスメ配送ドライバー・大阪府新エリア25件・追加バッチ）`);
