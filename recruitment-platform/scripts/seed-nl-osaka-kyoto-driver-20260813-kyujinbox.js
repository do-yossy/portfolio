...
'use strict';
/**
 * 株式会社NOWLIVE（nl）／配送・ルートドライバー 今日のバッチ（2026-08-13・求人ボックス掲載）— 大阪・京都
 ...
 *
 * 実行: node --experimental-sqlite scripts/seed-nl-osaka-kyoto-driver-20260813-kyujinbox.js
 */
...
const AREAS = [
  { area: '大阪市住吉区我孫子2丁目',   city: '大阪府大阪市住吉区我孫子2丁目' },
  { area: '大阪市東住吉区南田辺3丁目',   city: '大阪府大阪市東住吉区南田辺3丁目' },
  { area: '大阪市平野区瓜破東5丁目',   city: '大阪府大阪市平野区瓜破東5丁目' },
  { area: '大阪市西成区岸里1丁目',   city: '大阪府大阪市西成区岸里1丁目' },
  { area: '大阪市港区弁天2丁目',   city: '大阪府大阪市港区弁天2丁目' },
  { area: '大阪市大正区三軒家東4丁目',   city: '大阪府大阪市大正区三軒家東4丁目' },
  { area: '大阪市此花区酉島3丁目',   city: '大阪府大阪市此花区酉島3丁目' },
  { area: '大阪市淀川区塚本4丁目',   city: '大阪府大阪市淀川区塚本4丁目' },
  { area: '大阪市東淀川区大隅2丁目',   city: '大阪府大阪市東淀川区大隅2丁目' },
  { area: '大阪市旭区赤川3丁目',   city: '大阪府大阪市旭区赤川3丁目' },
  { area: '京都市中京区聚楽廻',   city: '京都府京都市中京区聚楽廻' },
  { area: '京都市下京区朱雀',   city: '京都府京都市下京区朱雀' },
  { area: '京都市南区河原町',   city: '京都府京都市南区河原町' },
  { area: '京都市右京区鳴滝',   city: '京都府京都市右京区鳴滝' },
  { area: '京都市左京区聖護院',   city: '京都府京都市左京区聖護院' },
  { area: '京都市東山区大和大路',   city: '京都府京都市東山区大和大路' },
  { area: '京都市山科区川田',   city: '京都府京都市山科区川田' },
  { area: '京都市伏見区久我',   city: '京都府京都市伏見区久我' },
  { area: '京都市北区上賀茂',   city: '京都府京都市北区上賀茂' },
  { area: '宇治市広野町',   city: '京都府宇治市広野町' },
  { area: '亀岡市保津町',   city: '京都府亀岡市保津町' },
  { area: '城陽市奈島',   city: '京都府城陽市奈島' },
  { area: '京田辺市三山木',   city: '京都府京田辺市三山木' },
  { area: '長岡京市調子',   city: '京都府長岡京市調子' },
  { area: '木津川市兜台',   city: '京都府木津川市兜台' },
];
