'use strict';
// ST（company='st' 有限会社Style501）大阪府 今日のバッチ（2026-08-10）：配送ドライバー10件＋送迎ドライバー15件＝25件（求人ボックス掲載）
...
const AREAS_HAISOU = [
  { pref: '大阪府', city: '大阪市', district: '西淀川区中島2丁目' },
  { pref: '大阪府', city: '大阪市', district: '住之江区東加賀屋3丁目' },
  { pref: '大阪府', city: '大阪市', district: '大正区小林東2丁目' },
  { pref: '大阪府', city: '大阪市', district: '西成区玉出東1丁目' },
  { pref: '大阪府', city: '大阪市', district: '港区波除4丁目' },
  { pref: '大阪府', city: '大阪市', district: '此花区高見1丁目' },
  { pref: '大阪府', city: '大阪市', district: '東成区神路2丁目' },
  { pref: '大阪府', city: '大阪市', district: '城東区放出西1丁目' },
  { pref: '大阪府', city: '大阪市', district: '鶴見区緑2丁目' },
  { pref: '大阪府', city: '大阪市', district: '生野区田島5丁目' },
];
...
const AREAS_SOUTEI = [
  { pref: '大阪府', city: '堺市', district: '堺区材木町東3丁' },
  { pref: '大阪府', city: '堺市', district: '中区深井北町' },
  { pref: '大阪府', city: '堺市', district: '東区引野町2丁' },
  { pref: '大阪府', city: '堺市', district: '西区上' },
  { pref: '大阪府', city: '堺市', district: '南区原山台3丁' },
  { pref: '大阪府', city: '堺市', district: '北区中村町' },
  { pref: '大阪府', city: '堺市', district: '美原区阿弥' },
  { pref: '大阪府', city: '和泉市', district: '尾井町' },
  { pref: '大阪府', city: '岸和田市', district: '加守町3丁目' },
  { pref: '大阪府', city: '泉大津市', district: '曽根町' },
  { pref: '大阪府', city: '貝塚市', district: '半田' },
  { pref: '大阪府', city: '泉佐野市', district: '上瓦屋' },
  { pref: '大阪府', city: '松原市', district: '新堂3丁目' },
  { pref: '大阪府', city: '大東市', district: '三箇4丁目' },
  { pref: '大阪府', city: '河内長野市', district: '松ヶ丘中町' },
];
