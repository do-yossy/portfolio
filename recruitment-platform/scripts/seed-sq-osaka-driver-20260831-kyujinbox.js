'use strict';
// SQ（company='sq'）大阪府 今日のバッチ（2026-08-31）：ルート配送ドライバー25件（求人ボックス掲載）
...
const HAISOU_AREAS = [
  { pref: '大阪府', city: '大阪市北区', district: '池田町', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市中央区', district: '徳井町1丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市西区', district: '九条南1丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市天王寺区', district: '空堀町', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市城東区', district: '森之宮2丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市旭区', district: '大宮2丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市鶴見区', district: '緑4丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市住吉区', district: '長居3丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市東住吉区', district: '中野2丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市平野区', district: '平野北1丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市都島区', district: '都島北通2丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市淀川区', district: '西宮原1丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市東成区', district: '大今里4丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '堺市堺区', district: '熊野町東3丁', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '堺市中区', district: '深井東町', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '東大阪市', district: '長田西2丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '吹田市', district: '江の木町2丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '豊中市', district: '岡町北3丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '高槻市', district: '芥川町4丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '茨木市', district: '上穂積3丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '枚方市', district: '香里ケ丘3丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '八尾市', district: '龍華町1丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '寝屋川市', district: '幸町', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '守口市', district: '京阪本通1丁目', client: '企業・商業施設向け日用品' },
