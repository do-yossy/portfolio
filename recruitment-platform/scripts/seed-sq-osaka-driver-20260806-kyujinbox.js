'use strict';
// SQ（company='sq'）大阪府 今日のバッチ（2026-08-06）：ルート配送ドライバー25件（求人ボックス掲載）
...
const HAISOU_AREAS = [
  { pref: '大阪府', city: '大阪市北区', district: '豊崎3丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市中央区', district: '内本町2丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市西区', district: '江戸堀1丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市天王寺区', district: '細工谷1丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市城東区', district: '野江4丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市旭区', district: '中宮5丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市鶴見区', district: '諸口5丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市住吉区', district: '長居東4丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市東住吉区', district: '湯里3丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市平野区', district: '瓜破西2丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市都島区', district: '中野町4丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市淀川区', district: '西中島3丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市東成区', district: '深江北2丁目', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '堺市堺区', district: '協和町3丁', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '堺市北区', district: '新金岡町5丁', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '東大阪市', district: '御厨栄町3丁目', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '吹田市', district: '春日3丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '豊中市', district: '服部本町4丁目', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '高槻市', district: '芥川町3丁目', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '茨木市', district: '中津町', client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '枚方市', district: '岡東町5丁目', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '八尾市', district: '南本町6丁目', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '寝屋川市', district: '香里南之町', client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '守口市', district: '大日町2丁目', client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '門真市', district: '石原町', client: '食品・日用品卸売' },
];
