'use strict';
// ST（company='st' 有限会社Style501）大阪府 今日のバッチ（2026-08-03）：配送ドライバー10件＋送迎ドライバー15件＝25件（求人ボックス掲載）
...
const AREAS_HAISOU = [
  { pref: '大阪府', city: '大阪市', district: '此花区春日出中2丁目' },
  { pref: '大阪府', city: '大阪市', district: '福島区玉川3丁目' },
  { pref: '大阪府', city: '大阪市', district: '淀川区加島1丁目' },
  { pref: '大阪府', city: '大阪市', district: '東淀川区豊里5丁目' },
  { pref: '大阪府', city: '大阪市', district: '生野区新今里4丁目' },
  { pref: '大阪府', city: '大阪市', district: '平野区喜連西3丁目' },
  { pref: '大阪府', city: '大阪市', district: '住吉区苅田7丁目' },
  { pref: '大阪府', city: '大阪市', district: '東住吉区今川4丁目' },
  { pref: '大阪府', city: '大阪市', district: '都島区高倉町2丁目' },
  { pref: '大阪府', city: '大阪市', district: '旭区清水5丁目' },
];
...
const AREAS_SOUTEI = [
  { pref: '大阪府', city: '堺市',       district: '堺区香ケ丘町3丁' },
  { pref: '大阪府', city: '堺市',       district: '中区深井清水町' },
  { pref: '大阪府', city: '堺市',       district: '東区日置荘西町5丁' },
  { pref: '大阪府', city: '堺市',       district: '西区鳳東町7丁' },
  { pref: '大阪府', city: '堺市',       district: '南区桃山台2丁' },
  { pref: '大阪府', city: '堺市',       district: '北区新金岡町4丁' },
  { pref: '大阪府', city: '和泉市',     district: '府中町2丁目' },
  { pref: '大阪府', city: '岸和田市',   district: '春木町' },
  { pref: '大阪府', city: '泉大津市',   district: '旭町' },
  { pref: '大阪府', city: '貝塚市',     district: '海塚1丁目' },
  { pref: '大阪府', city: '泉佐野市',   district: '高松東2丁目' },
  { pref: '大阪府', city: '松原市',     district: '阿保5丁目' },
  { pref: '大阪府', city: '大東市',     district: '住道2丁目' },
  { pref: '大阪府', city: '和泉市',     district: '和田町1丁目' },
  { pref: '大阪府', city: '泉佐野市',   district: '上町3丁目' },
];
