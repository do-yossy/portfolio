...
'use strict';
/**
 * 株式会社NOWLIVE（nl）／配送・ルートドライバー 今日のバッチ（2026-08-31・求人ボックス掲載）— 大阪・京都
 ...
 *
 * 実行: node --experimental-sqlite scripts/seed-nl-osaka-kyoto-driver-20260831-kyujinbox.js
 */
...
const AREAS = [
  { area: '大阪市住吉区我孫子3丁目',   city: '大阪府大阪市住吉区我孫子3丁目' },
  { area: '大阪市東住吉区田辺2丁目',   city: '大阪府大阪市東住吉区田辺2丁目' },
  { area: '大阪市平野区加美北2丁目',   city: '大阪府大阪市平野区加美北2丁目' },
  { area: '大阪市西成区玉出東2丁目',   city: '大阪府大阪市西成区玉出東2丁目' },
  { area: '大阪市港区弁天3丁目',   city: '大阪府大阪市港区弁天3丁目' },
  { area: '大阪市大正区泉尾3丁目',   city: '大阪府大阪市大正区泉尾3丁目' },
  { area: '大阪市此花区伝法6丁目',   city: '大阪府大阪市此花区伝法6丁目' },
  { area: '大阪市淀川区東三国1丁目',   city: '大阪府大阪市淀川区東三国1丁目' },
  { area: '大阪市東淀川区淡路3丁目',   city: '大阪府大阪市東淀川区淡路3丁目' },
  { area: '大阪市旭区中宮5丁目',   city: '大阪府大阪市旭区中宮5丁目' },
  { area: '京都市中京区西ノ京北聖町',   city: '京都府京都市中京区西ノ京北聖町' },
  { area: '京都市下京区堀川通',   city: '京都府京都市下京区堀川通' },
  { area: '京都市南区吉祥院向田町',   city: '京都府京都市南区吉祥院向田町' },
  { area: '京都市右京区嵯峨広沢',   city: '京都府京都市右京区嵯峨広沢' },
  { area: '京都市左京区南禅寺',   city: '京都府京都市左京区南禅寺' },
  { area: '京都市東山区妙法院前側町',   city: '京都府京都市東山区妙法院前側町' },
  { area: '京都市山科区竹鼻',   city: '京都府京都市山科区竹鼻' },
  { area: '京都市伏見区桃山',   city: '京都府京都市伏見区桃山' },
  { area: '京都市北区紫竹下ノ岸町',   city: '京都府京都市北区紫竹下ノ岸町' },
  { area: '宇治市槇島町本屋敷',   city: '京都府宇治市槇島町本屋敷' },
  { area: '亀岡市篠町広田',   city: '京都府亀岡市篠町広田' },
  { area: '城陽市水主',   city: '京都府城陽市水主' },
  { area: '向日市寺戸町七ノ坪',   city: '京都府向日市寺戸町七ノ坪' },
  { area: '長岡京市友岡',   city: '京都府長岡京市友岡' },
  { area: '木津川市州見台5丁目',   city: '京都府木津川市州見台5丁目' },
];
