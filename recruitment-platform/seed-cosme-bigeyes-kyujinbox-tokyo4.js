...
const AREAS = [
  { pref: '東京都', city: '大田区', district: '大森中' },
  { pref: '東京都', city: '大田区', district: '仲六郷' },
  { pref: '東京都', city: '江戸川区', district: '南葛西' },
  { pref: '東京都', city: '足立区', district: '興野' },
  { pref: '東京都', city: '葛飾区', district: '東立石' },
  { pref: '東京都', city: '板橋区', district: '東坂下' },
  { pref: '東京都', city: '江東区', district: '大島' },
  { pref: '東京都', city: '墨田区', district: '東向島' },
  { pref: '東京都', city: '北区', district: '上中里' },
  { pref: '東京都', city: '品川区', district: '二葉' },
];
...
console.log(`\n完了: ${created}件作成（Bigeyes・コスメ製造スタッフ・東京10件(第4弾)・本文は求人No.5148-4590-0005と同一）`);
