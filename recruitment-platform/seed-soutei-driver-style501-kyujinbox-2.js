...
const AREAS = [
  ...
  { pref: '東京都', city: '江戸川区', district: '小岩' },
  { pref: '東京都', city: '葛飾区', district: '亀有' },
  { pref: '東京都', city: '板橋区', district: '大山' },
  { pref: '東京都', city: '練馬区', district: '中村橋' },
  { pref: '東京都', city: '北区', district: '赤羽台' },
  { pref: '東京都', city: '荒川区', district: '西日暮里' },
  { pref: '東京都', city: '江東区', district: '亀戸' },
  { pref: '東京都', city: '大田区', district: '蒲田本町' },
  { pref: '東京都', city: '品川区', district: '戸越' },
  { pref: '東京都', city: '世田谷区', district: '経堂' },
  { pref: '東京都', city: '杉並区', district: '西荻窪' },
  { pref: '東京都', city: '中野区', district: '沼袋' },
  { pref: '東京都', city: '豊島区', district: '巣鴨' },
  { pref: '東京都', city: '足立区', district: '北千住' },
];
