'use strict';
// 工場軽作業スタッフ 求人10件・第7弾・全国（求人ボックス掲載）
// 月収30万円以上（月給30〜37万円）・第1〜6弾と被りなし
...
// 全国10エリア（軽作業第1〜6弾・機械オペレーター全弾と被りなし）
// 本弾: 北見,奥州,会津若松,足利,三条,掛川,豊川,総社,岩国,薩摩川内（いずれも未使用）
const AREAS = [
  { pref: '北海道',   city: '北見市',       facility: '食品・物流軽作業センター' },
  { pref: '岩手県',   city: '奥州市',       facility: '製造工場・部品組立ライン' },
  { pref: '福島県',   city: '会津若松市',   facility: '精密機器・食品加工工場' },
  { pref: '栃木県',   city: '足利市',       facility: '食品・機械部品製造工場' },
  { pref: '新潟県',   city: '三条市',       facility: '製造工場・部品組立ライン' },
  { pref: '静岡県',   city: '掛川市',       facility: '食品・機械部品製造工場' },
  { pref: '愛知県',   city: '豊川市',       facility: '製造工場・部品組立ライン' },
  { pref: '岡山県',   city: '総社市',       facility: '食品・日用品軽作業センター' },
  { pref: '山口県',   city: '岩国市',       facility: '化学・食品製造工場' },
  { pref: '鹿児島県', city: '薩摩川内市',   facility: '食品加工・物流軽作業センター' },
];
...
if (del.changes > 0) console.log(`既存工場軽作業スタッフ第7弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（${SALARY_INCOME}・工場軽作業スタッフ・全国10件・第7弾・応募情報を踏まえ内容強化）`);
