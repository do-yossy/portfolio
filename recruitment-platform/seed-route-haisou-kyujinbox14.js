'use strict';
// ルート配送ドライバー（企業配送）求人15件・第14弾（求人ボックス掲載）
// 大阪府内の未使用エリア（第7〜13弾と全エリア重複なし・区の再利用時は別地名）
// 給与は「月給42万円〜62万円」
// 冪等: 対象拠点のみ削除してから作り直す
...
// 本弾: 大阪府内の未使用エリア。市区は第7〜13弾で一巡したため、別地名で構成（勤務地文字列の重複なし）。
const AREAS = [
  { pref: '大阪府', city: '大阪市',   district: '北区南森町',     client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '大阪市',   district: '中央区淡路町',   client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '大阪市',   district: '西区靱本町',     client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '大阪市',   district: '淀川区新大阪',   client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市',   district: '東淀川区上新庄', client: '食品・工業用品メーカー' },
  { pref: '大阪府', city: '大阪市',   district: '城東区野江',     client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '大阪市',   district: '住之江区北加賀屋', client: '工場・物流センター向け' },
  { pref: '大阪府', city: '大阪市',   district: '平野区喜連瓜破', client: '食品・日用品卸売' },
  { pref: '大阪府', city: '大阪市',   district: '生野区巽',       client: '食品・工業資材メーカー' },
  { pref: '大阪府', city: '堺市',     district: '中区土師町',     client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '東大阪市', district: '瓢箪山',         client: '工場・倉庫向け資材' },
  { pref: '大阪府', city: '枚方市',   district: '樟葉',           client: '食品・日用品卸売' },
  { pref: '大阪府', city: '吹田市',   district: '山田',           client: '企業・商業施設向け日用品' },
  { pref: '大阪府', city: '豊中市',   district: '服部',           client: '医療機器・事業所向け用品' },
  { pref: '大阪府', city: '高槻市',   district: '富田',           client: '工場・倉庫向け資材' },
];
...
if (del.changes > 0) console.log(`既存ルート配送ドライバー第14弾を削除: ${del.changes}件`);
...
console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）第14弾・大阪府内の未使用エリア15件）`);
