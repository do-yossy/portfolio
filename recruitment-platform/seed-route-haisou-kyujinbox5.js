'use strict';
// ルート配送ドライバー（企業配送）追加2件（求人ボックス掲載・第4弾投稿漏れ補填）
// 冪等: 対象拠点のみ削除してから作り直す
...
const AREAS = [
  { pref: '大阪府', city: '高槻市', district: '摂津富田', client: '食品・飲料メーカー' },
  { pref: '大阪府', city: '枚方市', district: '樟葉',     client: '医療機器・事業所向け用品' },
];
...
【勤務期間】長期`;
  ...
  console.log(`✓ [${i + 1}/2] ${title.slice(0, 55)}`);
  created++;
}

console.log(`\n完了: ${created}件作成（ルート配送ドライバー（企業配送）補填2件）`);
