...
// 東京都内15エリア第3弾（Style501 配送ドライバー・既存分と被りなし）
const AREAS = [
  { pref: '東京都', city: '世田谷区', district: '代沢' },
  { pref: '東京都', city: '中野区', district: '大和町' },
  { pref: '東京都', city: '北区', district: '上十条' },
  { pref: '東京都', city: '品川区', district: '南品川' },
  { pref: '東京都', city: '大田区', district: '池上' },
  { pref: '東京都', city: '杉並区', district: '成田東' },
  { pref: '東京都', city: '板橋区', district: '赤塚' },
  { pref: '東京都', city: '江戸川区', district: '小松川' },
  { pref: '東京都', city: '江東区', district: '木場' },
  { pref: '東京都', city: '目黒区', district: '碑文谷' },
  { pref: '東京都', city: '練馬区', district: '平和台' },
  { pref: '東京都', city: '荒川区', district: '荒川' },
  { pref: '東京都', city: '葛飾区', district: '西新小岩' },
  { pref: '東京都', city: '足立区', district: '花畑' },
  { pref: '東京都', city: '世田谷区', district: '上北沢' },
];
...
console.log(`\n完了: ${created}件作成（Style501・配送ドライバー・東京都15件(第3弾)）`);
