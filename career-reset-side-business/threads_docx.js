...
H('1. プロフィール設計（アポの土台）');
p('プロフィールは“24時間働く営業マン”。投稿で興味を持った人が最初に見る場所です。下記をそのまま設定してください（見た目の完成イメージは別紙「Threadsプロフィール設定シート」を参照）。');
sub('表示名（どれか）');
copy(['安藤｜30代女性の「働き方とお金」整理','30代の働き方とお金の整理｜安藤','キャリアとお金の整理室（30代女性向け）']);
sub('ユーザーネーム（＠／空きを確認して1つ）');
copy(['career_money_ando','hatarakikata_seiri','career.reset.30']);
sub('自己紹介文（bio・3案／150字目安）');
copy(['#A（共感型）','「今のままでいいのかな」が消えない30代女性へ。退職・転職・副業・お金を“事実ベース”で一緒に整理。煽りません・答えは押しつけません。▼無料「退職前チェックリスト」は下のリンクから','#B（機能型）','30代女性の「働き方とお金」整理｜失業手当・傷病手当金・退職後のお金をやさしく中立に解説｜“辞める前に知っておきたいこと”を発信｜無料特典は下↓','#C（やわらかめ）','会社員のままでも、辞めても。30代女性の“これからの働き方とお金”を一緒に整理します。制度はやさしく・中立に。無料「退職前チェックリスト」配布中↓']);
sub('リンク（1本だけ）');
...
sub('開設直後の最初の3投稿');
li(['自己紹介＆スタンス（上のピン投稿をそのまま）','お役立ち＋導線（下の投稿例②：失業手当の誤解）','保存される一覧（下の投稿例⑤：退職前チェック）']);
sub('アカウント設定メモ');
li(['ThreadsはInstagram連携が必須。連携先がHP制作・求人系なら、この発信用に新しいInstagram（＝新Threads）を作ると世界観が混ざらない。','アイコンは本人写真かロゴ。清潔感・安心感を優先。','仕事用LINEも名前・アイコン・公開範囲を「仕事用」に整える。']);
